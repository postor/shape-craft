import{g as Ae,c as te,k as oe,C as de,m as Le,n as Se,b as ue,d as pe,e as we,f as xe,h as Ne,v as G,i as qe,o as Te,j as me,P as Me}from"./index-DT0ki_L2.js";import{u as Ie}from"./scene-graph-DFWsmROI.js";import{V as Re}from"./three-view-CJN9FKYK.js";import{c as je}from"./ruler-C0x4Swwc.js";import{f as ae,b as Pe,r as He}from"./instance-Bkb3ne79.js";import{C as Fe}from"./character-anim-BH4CjJkQ.js";import"./OrbitControls-DSEP_P5-.js";import"./TransformControls-KuiheJs1.js";async function Be(h,$,k){var ie;const b=document.createElement("div");b.className="editor-page",h.appendChild(b);let c,A=k,L=de.includes($??"")?$:"humanoid";if(k){const e=await Ae(k);e?(c=e,e.characterType&&(L=e.characterType)):c=te("Untitled","character")}else c={...te(L,"character"),...oe(L)};const U=document.createElement("div");U.className="editor-layout";const j=document.createElement("div");j.className="panel hierarchy";const V=document.createElement("div");V.className="panel viewport-panel";const P=document.createElement("div");P.className="panel inspector",U.append(j,V,P),b.appendChild(U);const q=document.createElement("div");q.className="toolbar",q.innerHTML=`
