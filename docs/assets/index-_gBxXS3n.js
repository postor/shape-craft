...
`)+`
`+m);const M=w+f+a,y=w+m+o,L=Rl(s,s.VERTEX_SHADER,M),R=Rl(s,s.FRAGMENT_SHADER,y);s.attachShader(x,L),s.attachShader(x,R),t.index0AttributeName!==void 0?s.bindAttribLocation(x,0,t.index0AttributeName):t.morphTargets===!0&&s.bindAttribLocation(x,0,"position"),s.linkProgram(x);function C(S){if(i.debug.checkShaderErrors){const O=s.getProgramInfoLog(x).trim(),k=s.getShaderInfoLog(L).trim(),V=s.getShaderInfoLog(R).trim();let q=!0,G=!0;if(s.getProgramParameter(x,s.LINK_STATUS)===!1)if(q=!1,typeof i.debug.onShaderError=="function")i.debug.onShaderError(s,x,L,R);else{const ce=Cl(s,L,"vertex"),K=Cl(s,R,"fragment");console.error("THREE.WebGLProgram: Shader Error "+s.getError()+" - VALIDATE_STATUS "+s.getProgramParameter(x,s.VALIDATE_STATUS)+`
...
Program Info Log: `+O+`
`+ce+`
`+K)}else O!==""?console.warn("THREE.WebGLProgram: Program Info Log:",O):(k===""||V==="")&&(G=!1);G&&(S.diagnostics={runnable:q,programLog:O,vertexShader:{log:k,prefix:f},fragmentShader:{log:V,prefix:m}})}s.deleteShader(L),s.deleteShader(R),z=new Pr(s,x),ne=Dg(s,x)}let z;this.getUniforms=function(){return z===void 0&&C(this),z};let ne;this.getAttributes=function(){return ne===void 0&&C(this),ne};let _=t.rendererExtensionParallelShaderCompile===!1;return this.isReady=function(){return _===!1&&(_=s.getProgramParameter(x,Eg)),_},this.destroy=function(){n.releaseStatesOfProgram(this),s.deleteProgram(x),this.program=void 0},this.type=t.shaderType,this.name=t.shaderName,this.id=wg++,this.cacheKey=e,this.usedTimes=1,this.program=x,this.vertexShader=L,this.fragmentShader=R,this}let jg=0;class Xg{constructor(){this.shaderCache=new Map,this.materialCache=new Map}update(e){const t=e.vertexShader,n=e.fragmentShader,s=this._getShaderStage(t),r=this._getShaderStage(n),a=this._getShaderCacheForMaterial(e);return a.has(s)===!1&&(a.add(s),s.usedTimes++),a.has(r)===!1&&(a.add(r),r.usedTimes++),this}remove(e){const t=this.materialCache.get(e);for(const n of t)n.usedTimes--,n.usedTimes===0&&this.shaderCache.delete(n.code);return this.materialCache.delete(e),this}getVertexShaderID(e){return this._getShaderStage(e.vertexShader).id}getFragmentShaderID(e){return this._getShaderStage(e.fragmentShader).id}dispose(){this.shaderCache.clear(),this.materialCache.clear()}_getShaderCacheForMaterial(e){const t=this.materialCache;let n=t.get(e);return n===void 0&&(n=new Set,t.set(e,n)),n}_getShaderStage(e){const t=this.shaderCache;let n=t.get(e);return n===void 0&&(n=new qg(e),t.set(e,n)),n}}class qg{constructor(e){this.id=jg++,this.code=e,this.usedTimes=0}}function $g(i,e,t,n,s,r,a){const o=new dc,c=new Xg,l=new Set,h=[],p=s.logarithmicDepthBuffer,d=s.reverseDepthBuffer,u=s.vertexTextures;let g=s.precision;const x={MeshDepthMaterial:"depth",MeshDistanceMaterial:"distanceRGBA",MeshNormalMaterial:"normal",MeshBasicMaterial:"basic",MeshLambertMaterial:"lambert",MeshPhongMaterial:"phong",MeshToonMaterial:"toon",MeshStandardMaterial:"physical",MeshPhysicalMaterial:"physical",MeshMatcapMaterial:"matcap",LineBasicMaterial:"basic",LineDashedMaterial:"dashed",PointsMaterial:"points",ShadowMaterial:"shadow",SpriteMaterial:"sprite"};function f(_){return l.add(_),_===0?"uv":`uv${_}`}function m(_,S,O,k,V){const q=k.fog,G=V.geometry,ce=_.isMeshStandardMaterial?k.environment:null,K=(_.isMeshStandardMaterial?t:e).get(_.envMap||ce),me=K&&K.mapping===Jr?K.image.height:null,xe=x[_.type];_.precision!==null&&(g=s.getMaxPrecision(_.precision),g!==_.precision&&console.warn("THREE.WebGLProgram.getParameters:",_.precision,"not supported, using",g,"instead."));const ve=G.morphAttributes.position||G.morphAttributes.normal||G.morphAttributes.color,ie=ve!==void 0?ve.length:0;let le=0;G.morphAttributes.position!==void 0&&(le=1),G.morphAttributes.normal!==void 0&&(le=2),G.morphAttributes.color!==void 0&&(le=3);let A,I,X,Y;if(xe){const Gt=yn[xe];A=Gt.vertexShader,I=Gt.fragmentShader}else A=_.vertexShader,I=_.fragmentShader,c.update(_),X=c.getVertexShaderID(_),Y=c.getFragmentShaderID(_);const fe=i.getRenderTarget(),U=V.isInstancedMesh===!0,te=V.isBatchedMesh===!0,ye=!!_.map,de=!!_.matcap,E=!!K,B=!!_.aoMap,re=!!_.lightMap,pe=!!_.bumpMap,ge=!!_.normalMap,De=!!_.displacementMap,he=!!_.emissiveMap,b=!!_.metalnessMap,v=!!_.roughnessMap,N=_.anisotropy>0,J=_.clearcoat>0,oe=_.dispersion>0,ae=_.iridescence>0,Ae=_.sheen>0,be=_.transmission>0,we=N&&!!_.anisotropyMap,qe=J&&!!_.clearcoatMap,Me=J&&!!_.clearcoatNormalMap,Ie=J&&!!_.clearcoatRoughnessMap,He=ae&&!!_.iridescenceMap,We=ae&&!!_.iridescenceThicknessMap,Ue=Ae&&!!_.sheenColorMap,Ke=Ae&&!!_.sheenRoughnessMap,Xe=!!_.specularMap,ot=!!_.specularColorMap,F=!!_.specularIntensityMap,Le=be&&!!_.transmissionMap,se=be&&!!_.thicknessMap,_e=!!_.gradientMap,Re=!!_.alphaMap,Pe=_.alphaTest>0,Ze=!!_.alphaHash,Mt=!!_.extensions;let Ht=Zn;_.toneMapped&&(fe===null||fe.isXRRenderTarget===!0)&&(Ht=i.toneMapping);const Je={shaderID:xe,shaderType:_.type,shaderName:_.name,vertexShader:A,fragmentShader:I,defines:_.defines,customVertexShaderID:X,customFragmentShaderID:Y,isRawShaderMaterial:_.isRawShaderMaterial===!0,glslVersion:_.glslVersion,precision:g,batching:te,batchingColor:te&&V._colorsTexture!==null,instancing:U,instancingColor:U&&V.instanceColor!==null,instancingMorph:U&&V.morphTexture!==null,supportsVertexTextures:u,outputColorSpace:fe===null?i.outputColorSpace:fe.isXRRenderTarget===!0?fe.texture.colorSpace:ni,alphaToCoverage:!!_.alphaToCoverage,map:ye,matcap:de,envMap:E,envMapMode:E&&K.mapping,envMapCubeUVHeight:me,aoMap:B,lightMap:re,bumpMap:pe,normalMap:ge,displacementMap:u&&De,emissiveMap:he,normalMapObjectSpace:ge&&_.normalMapType===Qu,normalMapTangentSpace:ge&&_.normalMapType===jh,metalnessMap:b,roughnessMap:v,anisotropy:N,anisotropyMap:we,clearcoat:J,clearcoatMap:qe,clearcoatNormalMap:Me,clearcoatRoughnessMap:Ie,dispersion:oe,iridescence:ae,iridescenceMap:He,iridescenceThicknessMap:We,sheen:Ae,sheenColorMap:Ue,sheenRoughnessMap:Ke,specularMap:Xe,specularColorMap:ot,specularIntensityMap:F,transmission:be,transmissionMap:Le,thicknessMap:se,gradientMap:_e,opaque:_.transparent===!1&&_.blending===Ji&&_.alphaToCoverage===!1,alphaMap:Re,alphaTest:Pe,alphaHash:Ze,combine:_.combine,mapUv:ye&&f(_.map.channel),aoMapUv:B&&f(_.aoMap.channel),lightMapUv:re&&f(_.lightMap.channel),bumpMapUv:pe&&f(_.bumpMap.channel),normalMapUv:ge&&f(_.normalMap.channel),displacementMapUv:De&&f(_.displacementMap.channel),emissiveMapUv:he&&f(_.emissiveMap.channel),metalnessMapUv:b&&f(_.metalnessMap.channel),roughnessMapUv:v&&f(_.roughnessMap.channel),anisotropyMapUv:we&&f(_.anisotropyMap.channel),clearcoatMapUv:qe&&f(_.clearcoatMap.channel),clearcoatNormalMapUv:Me&&f(_.clearcoatNormalMap.channel),clearcoatRoughnessMapUv:Ie&&f(_.clearcoatRoughnessMap.channel),iridescenceMapUv:He&&f(_.iridescenceMap.channel),iridescenceThicknessMapUv:We&&f(_.iridescenceThicknessMap.channel),sheenColorMapUv:Ue&&f(_.sheenColorMap.channel),sheenRoughnessMapUv:Ke&&f(_.sheenRoughnessMap.channel),specularMapUv:Xe&&f(_.specularMap.channel),specularColorMapUv:ot&&f(_.specularColorMap.channel),specularIntensityMapUv:F&&f(_.specularIntensityMap.channel),transmissionMapUv:Le&&f(_.transmissionMap.channel),thicknessMapUv:se&&f(_.thicknessMap.channel),alphaMapUv:Re&&f(_.alphaMap.channel),vertexTangents:!!G.attributes.tangent&&(ge||N),vertexColors:_.vertexColors,vertexAlphas:_.vertexColors===!0&&!!G.attributes.color&&G.attributes.color.itemSize===4,pointsUvs:V.isPoints===!0&&!!G.attributes.uv&&(ye||Re),fog:!!q,useFog:_.fog===!0,fogExp2:!!q&&q.isFogExp2,flatShading:_.flatShading===!0,sizeAttenuation:_.sizeAttenuation===!0,logarithmicDepthBuffer:p,reverseDepthBuffer:d,skinning:V.isSkinnedMesh===!0,morphTargets:G.morphAttributes.position!==void 0,morphNormals:G.morphAttributes.normal!==void 0,morphColors:G.morphAttributes.color!==void 0,morphTargetsCount:ie,morphTextureStride:le,numDirLights:S.directional.length,numPointLights:S.point.length,numSpotLights:S.spot.length,numSpotLightMaps:S.spotLightMap.length,numRectAreaLights:S.rectArea.length,numHemiLights:S.hemi.length,numDirLightShadows:S.directionalShadowMap.length,numPointLightShadows:S.pointShadowMap.length,numSpotLightShadows:S.spotShadowMap.length,numSpotLightShadowsWithMaps:S.numSpotLightShadowsWithMaps,numLightProbes:S.numLightProbes,numClippingPlanes:a.numPlanes,numClipIntersection:a.numIntersection,dithering:_.dithering,shadowMapEnabled:i.shadowMap.enabled&&O.length>0,shadowMapType:i.shadowMap.type,toneMapping:Ht,decodeVideoTexture:ye&&_.map.isVideoTexture===!0&&tt.getTransfer(_.map.colorSpace)===ht,premultipliedAlpha:_.premultipliedAlpha,doubleSided:_.side===jt,flipSided:_.side===Xt,useDepthPacking:_.depthPacking>=0,depthPacking:_.depthPacking||0,index0AttributeName:_.index0AttributeName,extensionClipCullDistance:Mt&&_.extensions.clipCullDistance===!0&&n.has("WEBGL_clip_cull_distance"),extensionMultiDraw:(Mt&&_.extensions.multiDraw===!0||te)&&n.has("WEBGL_multi_draw"),rendererExtensionParallelShaderCompile:n.has("KHR_parallel_shader_compile"),customProgramCacheKey:_.customProgramCacheKey()};return Je.vertexUv1s=l.has(1),Je.vertexUv2s=l.has(2),Je.vertexUv3s=l.has(3),l.clear(),Je}function w(_){const S=[];if(_.shaderID?S.push(_.shaderID):(S.push(_.customVertexShaderID),S.push(_.customFragmentShaderID)),_.defines!==void 0)for(const O in _.defines)S.push(O),S.push(_.defines[O]);return _.isRawShaderMaterial===!1&&(M(S,_),y(S,_),S.push(i.outputColorSpace)),S.push(_.customProgramCacheKey),S.join()}function M(_,S){_.push(S.precision),_.push(S.outputColorSpace),_.push(S.envMapMode),_.push(S.envMapCubeUVHeight),_.push(S.mapUv),_.push(S.alphaMapUv),_.push(S.lightMapUv),_.push(S.aoMapUv),_.push(S.bumpMapUv),_.push(S.normalMapUv),_.push(S.displacementMapUv),_.push(S.emissiveMapUv),_.push(S.metalnessMapUv),_.push(S.roughnessMapUv),_.push(S.anisotropyMapUv),_.push(S.clearcoatMapUv),_.push(S.clearcoatNormalMapUv),_.push(S.clearcoatRoughnessMapUv),_.push(S.iridescenceMapUv),_.push(S.iridescenceThicknessMapUv),_.push(S.sheenColorMapUv),_.push(S.sheenRoughnessMapUv),_.push(S.specularMapUv),_.push(S.specularColorMapUv),_.push(S.specularIntensityMapUv),_.push(S.transmissionMapUv),_.push(S.thicknessMapUv),_.push(S.combine),_.push(S.fogExp2),_.push(S.sizeAttenuation),_.push(S.morphTargetsCount),_.push(S.morphAttributeCount),_.push(S.numDirLights),_.push(S.numPointLights),_.push(S.numSpotLights),_.push(S.numSpotLightMaps),_.push(S.numHemiLights),_.push(S.numRectAreaLights),_.push(S.numDirLightShadows),_.push(S.numPointLightShadows),_.push(S.numSpotLightShadows),_.push(S.numSpotLightShadowsWithMaps),_.push(S.numLightProbes),_.push(S.shadowMapType),_.push(S.toneMapping),_.push(S.numClippingPlanes),_.push(S.numClipIntersection),_.push(S.depthPacking)}function y(_,S){o.disableAll(),S.supportsVertexTextures&&o.enable(0),S.instancing&&o.enable(1),S.instancingColor&&o.enable(2),S.instancingMorph&&o.enable(3),S.matcap&&o.enable(4),S.envMap&&o.enable(5),S.normalMapObjectSpace&&o.enable(6),S.normalMapTangentSpace&&o.enable(7),S.clearcoat&&o.enable(8),S.iridescence&&o.enable(9),S.alphaTest&&o.enable(10),S.vertexColors&&o.enable(11),S.vertexAlphas&&o.enable(12),S.vertexUv1s&&o.enable(13),S.vertexUv2s&&o.enable(14),S.vertexUv3s&&o.enable(15),S.vertexTangents&&o.enable(16),S.anisotropy&&o.enable(17),S.alphaHash&&o.enable(18),S.batching&&o.enable(19),S.dispersion&&o.enable(20),S.batchingColor&&o.enable(21),_.push(o.mask),o.disableAll(),S.fog&&o.enable(0),S.useFog&&o.enable(1),S.flatShading&&o.enable(2),S.logarithmicDepthBuffer&&o.enable(3),S.reverseDepthBuffer&&o.enable(4),S.skinning&&o.enable(5),S.morphTargets&&o.enable(6),S.morphNormals&&o.enable(7),S.morphColors&&o.enable(8),S.premultipliedAlpha&&o.enable(9),S.shadowMapEnabled&&o.enable(10),S.doubleSided&&o.enable(11),S.flipSided&&o.enable(12),S.useDepthPacking&&o.enable(13),S.dithering&&o.enable(14),S.transmission&&o.enable(15),S.sheen&&o.enable(16),S.opaque&&o.enable(17),S.pointsUvs&&o.enable(18),S.decodeVideoTexture&&o.enable(19),S.alphaToCoverage&&o.enable(20),_.push(o.mask)}function L(_){const S=x[_.type];let O;if(S){const k=yn[S];O=Pf.clone(k.uniforms)}else O=_.uniforms;return O}function R(_,S){let O;for(let k=0,V=h.length;k<V;k++){const q=h[k];if(q.cacheKey===S){O=q,++O.usedTimes;break}}return O===void 0&&(O=new Wg(i,S,_,r),h.push(O)),O}function C(_){if(--_.usedTimes===0){const S=h.indexOf(_);h[S]=h[h.length-1],h.pop(),_.destroy()}}function z(_){c.remove(_)}function ne(){c.dispose()}return{getParameters:m,getProgramCacheKey:w,getUniforms:L,acquireProgram:R,releaseProgram:C,releaseShaderCache:z,programs:h,dispose:ne}}function Yg(){let i=new WeakMap;function e(a){return i.has(a)}function t(a){let o=i.get(a);return o===void 0&&(o={},i.set(a,o)),o}function n(a){i.delete(a)}function s(a,o,c){i.get(a)[o]=c}function r(){i=new WeakMap}return{has:e,get:t,remove:n,update:s,dispose:r}}function Kg(i,e){return i.groupOrder!==e.groupOrder?i.groupOrder-e.groupOrder:i.renderOrder!==e.renderOrder?i.renderOrder-e.renderOrder:i.material.id!==e.material.id?i.material.id-e.material.id:i.z!==e.z?i.z-e.z:i.id-e.id}function Ul(i,e){return i.groupOrder!==e.groupOrder?i.groupOrder-e.groupOrder:i.renderOrder!==e.renderOrder?i.renderOrder-e.renderOrder:i.z!==e.z?e.z-i.z:i.id-e.id}function Nl(){const i=[];let e=0;const t=[],n=[],s=[];function r(){e=0,t.length=0,n.length=0,s.length=0}function a(p,d,u,g,x,f){let m=i[e];return m===void 0?(m={id:p.id,object:p,geometry:d,material:u,groupOrder:g,renderOrder:p.renderOrder,z:x,group:f},i[e]=m):(m.id=p.id,m.object=p,m.geometry=d,m.material=u,m.groupOrder=g,m.renderOrder=p.renderOrder,m.z=x,m.group=f),e++,m}function o(p,d,u,g,x,f){const m=a(p,d,u,g,x,f);u.transmission>0?n.push(m):u.transparent===!0?s.push(m):t.push(m)}function c(p,d,u,g,x,f){const m=a(p,d,u,g,x,f);u.transmission>0?n.unshift(m):u.transparent===!0?s.unshift(m):t.unshift(m)}function l(p,d){t.length>1&&t.sort(p||Kg),n.length>1&&n.sort(d||Ul),s.length>1&&s.sort(d||Ul)}function h(){for(let p=e,d=i.length;p<d;p++){const u=i[p];if(u.id===null)break;u.id=null,u.object=null,u.geometry=null,u.material=null,u.group=null}}return{opaque:t,transmissive:n,transparent:s,init:r,push:o,unshift:c,finish:h,sort:l}}function Zg(){let i=new WeakMap;function e(n,s){const r=i.get(n);let a;return r===void 0?(a=new Nl,i.set(n,[a])):s>=r.length?(a=new Nl,r.push(a)):a=r[s],a}function t(){i=new WeakMap}return{get:e,dispose:t}}function Jg(){const i={};return{get:function(e){if(i[e.id]!==void 0)return i[e.id];let t;switch(e.type){case"DirectionalLight":t={direction:new D,color:new je};break;case"SpotLight":t={position:new D,direction:new D,color:new je,distance:0,coneCos:0,penumbraCos:0,decay:0};break;case"PointLight":t={position:new D,color:new je,distance:0,decay:0};break;case"HemisphereLight":t={direction:new D,skyColor:new je,groundColor:new je};break;case"RectAreaLight":t={color:new je,position:new D,halfWidth:new D,halfHeight:new D};break}return i[e.id]=t,t}}}function Qg(){const i={};return{get:function(e){if(i[e.id]!==void 0)return i[e.id];let t;switch(e.type){case"DirectionalLight":t={shadowIntensity:1,shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new ke};break;case"SpotLight":t={shadowIntensity:1,shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new ke};break;case"PointLight":t={shadowIntensity:1,shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new ke,shadowCameraNear:1,shadowCameraFar:1e3};break}return i[e.id]=t,t}}}let e_=0;function t_(i,e){return(e.castShadow?2:0)-(i.castShadow?2:0)+(e.map?1:0)-(i.map?1:0)}function n_(i){const e=new Jg,t=Qg(),n={version:0,hash:{directionalLength:-1,pointLength:-1,spotLength:-1,rectAreaLength:-1,hemiLength:-1,numDirectionalShadows:-1,numPointShadows:-1,numSpotShadows:-1,numSpotMaps:-1,numLightProbes:-1},ambient:[0,0,0],probe:[],directional:[],directionalShadow:[],directionalShadowMap:[],directionalShadowMatrix:[],spot:[],spotLightMap:[],spotShadow:[],spotShadowMap:[],spotLightMatrix:[],rectArea:[],rectAreaLTC1:null,rectAreaLTC2:null,point:[],pointShadow:[],pointShadowMap:[],pointShadowMatrix:[],hemi:[],numSpotLightShadowsWithMaps:0,numLightProbes:0};for(let l=0;l<9;l++)n.probe.push(new D);const s=new D,r=new at,a=new at;function o(l){let h=0,p=0,d=0;for(let ne=0;ne<9;ne++)n.probe[ne].set(0,0,0);let u=0,g=0,x=0,f=0,m=0,w=0,M=0,y=0,L=0,R=0,C=0;l.sort(t_);for(let ne=0,_=l.length;ne<_;ne++){const S=l[ne],O=S.color,k=S.intensity,V=S.distance,q=S.shadow&&S.shadow.map?S.shadow.map.texture:null;if(S.isAmbientLight)h+=O.r*k,p+=O.g*k,d+=O.b*k;else if(S.isLightProbe){for(let G=0;G<9;G++)n.probe[G].addScaledVector(S.sh.coefficients[G],k);C++}else if(S.isDirectionalLight){const G=e.get(S);if(G.color.copy(S.color).multiplyScalar(S.intensity),S.castShadow){const ce=S.shadow,K=t.get(S);K.shadowIntensity=ce.intensity,K.shadowBias=ce.bias,K.shadowNormalBias=ce.normalBias,K.shadowRadius=ce.radius,K.shadowMapSize=ce.mapSize,n.directionalShadow[u]=K,n.directionalShadowMap[u]=q,n.directionalShadowMatrix[u]=S.shadow.matrix,w++}n.directional[u]=G,u++}else if(S.isSpotLight){const G=e.get(S);G.position.setFromMatrixPosition(S.matrixWorld),G.color.copy(O).multiplyScalar(k),G.distance=V,G.coneCos=Math.cos(S.angle),G.penumbraCos=Math.cos(S.angle*(1-S.penumbra)),G.decay=S.decay,n.spot[x]=G;const ce=S.shadow;if(S.map&&(n.spotLightMap[L]=S.map,L++,ce.updateMatrices(S),S.castShadow&&R++),n.spotLightMatrix[x]=ce.matrix,S.castShadow){const K=t.get(S);K.shadowIntensity=ce.intensity,K.shadowBias=ce.bias,K.shadowNormalBias=ce.normalBias,K.shadowRadius=ce.radius,K.shadowMapSize=ce.mapSize,n.spotShadow[x]=K,n.spotShadowMap[x]=q,y++}x++}else if(S.isRectAreaLight){const G=e.get(S);G.color.copy(O).multiplyScalar(k),G.halfWidth.set(S.width*.5,0,0),G.halfHeight.set(0,S.height*.5,0),n.rectArea[f]=G,f++}else if(S.isPointLight){const G=e.get(S);if(G.color.copy(S.color).multiplyScalar(S.intensity),G.distance=S.distance,G.decay=S.decay,S.castShadow){const ce=S.shadow,K=t.get(S);K.shadowIntensity=ce.intensity,K.shadowBias=ce.bias,K.shadowNormalBias=ce.normalBias,K.shadowRadius=ce.radius,K.shadowMapSize=ce.mapSize,K.shadowCameraNear=ce.camera.near,K.shadowCameraFar=ce.camera.far,n.pointShadow[g]=K,n.pointShadowMap[g]=q,n.pointShadowMatrix[g]=S.shadow.matrix,M++}n.point[g]=G,g++}else if(S.isHemisphereLight){const G=e.get(S);G.skyColor.copy(S.color).multiplyScalar(k),G.groundColor.copy(S.groundColor).multiplyScalar(k),n.hemi[m]=G,m++}}f>0&&(i.has("OES_texture_float_linear")===!0?(n.rectAreaLTC1=Te.LTC_FLOAT_1,n.rectAreaLTC2=Te.LTC_FLOAT_2):(n.rectAreaLTC1=Te.LTC_HALF_1,n.rectAreaLTC2=Te.LTC_HALF_2)),n.ambient[0]=h,n.ambient[1]=p,n.ambient[2]=d;const z=n.hash;(z.directionalLength!==u||z.pointLength!==g||z.spotLength!==x||z.rectAreaLength!==f||z.hemiLength!==m||z.numDirectionalShadows!==w||z.numPointShadows!==M||z.numSpotShadows!==y||z.numSpotMaps!==L||z.numLightProbes!==C)&&(n.directional.length=u,n.spot.length=x,n.rectArea.length=f,n.point.length=g,n.hemi.length=m,n.directionalShadow.length=w,n.directionalShadowMap.length=w,n.pointShadow.length=M,n.pointShadowMap.length=M,n.spotShadow.length=y,n.spotShadowMap.length=y,n.directionalShadowMatrix.length=w,n.pointShadowMatrix.length=M,n.spotLightMatrix.length=y+L-R,n.spotLightMap.length=L,n.numSpotLightShadowsWithMaps=R,n.numLightProbes=C,z.directionalLength=u,z.pointLength=g,z.spotLength=x,z.rectAreaLength=f,z.hemiLength=m,z.numDirectionalShadows=w,z.numPointShadows=M,z.numSpotShadows=y,z.numSpotMaps=L,z.numLightProbes=C,n.version=e_++)}function c(l,h){let p=0,d=0,u=0,g=0,x=0;const f=h.matrixWorldInverse;for(let m=0,w=l.length;m<w;m++){const M=l[m];if(M.isDirectionalLight){const y=n.directional[p];y.direction.setFromMatrixPosition(M.matrixWorld),s.setFromMatrixPosition(M.target.matrixWorld),y.direction.sub(s),y.direction.transformDirection(f),p++}else if(M.isSpotLight){const y=n.spot[u];y.position.setFromMatrixPosition(M.matrixWorld),y.position.applyMatrix4(f),y.direction.setFromMatrixPosition(M.matrixWorld),s.setFromMatrixPosition(M.target.matrixWorld),y.direction.sub(s),y.direction.transformDirection(f),u++}else if(M.isRectAreaLight){const y=n.rectArea[g];y.position.setFromMatrixPosition(M.matrixWorld),y.position.applyMatrix4(f),a.identity(),r.copy(M.matrixWorld),r.premultiply(f),a.extractRotation(r),y.halfWidth.set(M.width*.5,0,0),y.halfHeight.set(0,M.height*.5,0),y.halfWidth.applyMatrix4(a),y.halfHeight.applyMatrix4(a),g++}else if(M.isPointLight){const y=n.point[d];y.position.setFromMatrixPosition(M.matrixWorld),y.position.applyMatrix4(f),d++}else if(M.isHemisphereLight){const y=n.hemi[x];y.direction.setFromMatrixPosition(M.matrixWorld),y.direction.transformDirection(f),x++}}}return{setup:o,setupView:c,state:n}}function Ol(i){const e=new n_(i),t=[],n=[];function s(h){l.camera=h,t.length=0,n.length=0}function r(h){t.push(h)}function a(h){n.push(h)}function o(){e.setup(t)}function c(h){e.setupView(t,h)}const l={lightsArray:t,shadowsArray:n,camera:null,lights:e,transmissionRenderTarget:{}};return{init:s,state:l,setupLights:o,setupLightsView:c,pushLight:r,pushShadow:a}}function i_(i){let e=new WeakMap;function t(s,r=0){const a=e.get(s);let o;return a===void 0?(o=new Ol(i),e.set(s,[o])):r>=a.length?(o=new Ol(i),a.push(o)):o=a[r],o}function n(){e=new WeakMap}return{get:t,dispose:n}}class s_ extends Ri{constructor(e){super(),this.isMeshDepthMaterial=!0,this.type="MeshDepthMaterial",this.depthPacking=Zu,this.map=null,this.alphaMap=null,this.displacementMap=null,this.displacementScale=1,this.displacementBias=0,this.wireframe=!1,this.wireframeLinewidth=1,this.setValues(e)}copy(e){return super.copy(e),this.depthPacking=e.depthPacking,this.map=e.map,this.alphaMap=e.alphaMap,this.displacementMap=e.displacementMap,this.displacementScale=e.displacementScale,this.displacementBias=e.displacementBias,this.wireframe=e.wireframe,this.wireframeLinewidth=e.wireframeLinewidth,this}}class r_ extends Ri{constructor(e){super(),this.isMeshDistanceMaterial=!0,this.type="MeshDistanceMaterial",this.map=null,this.alphaMap=null,this.displacementMap=null,this.displacementScale=1,this.displacementBias=0,this.setValues(e)}copy(e){return super.copy(e),this.map=e.map,this.alphaMap=e.alphaMap,this.displacementMap=e.displacementMap,this.displacementScale=e.displacementScale,this.displacementBias=e.displacementBias,this}}const a_=`void main() {
	gl_Position = vec4( position, 1.0 );
...
}`;function c_(i,e,t){let n=new uc;const s=new ke,r=new ke,a=new vt,o=new s_({depthPacking:Ju}),c=new r_,l={},h=t.maxTextureSize,p={[Qn]:Xt,[Xt]:Qn,[jt]:jt},d=new ei({defines:{VSM_SAMPLES:8},uniforms:{shadow_pass:{value:null},resolution:{value:new ke},radius:{value:4}},vertexShader:a_,fragmentShader:o_}),u=d.clone();u.defines.HORIZONTAL_PASS=1;const g=new ct;g.setAttribute("position",new Lt(new Float32Array([-1,-1,.5,3,-1,.5,-1,3,.5]),3));const x=new Ee(g,d),f=this;this.enabled=!1,this.autoUpdate=!0,this.needsUpdate=!1,this.type=Ih;let m=this.type;this.render=function(R,C,z){if(f.enabled===!1||f.autoUpdate===!1&&f.needsUpdate===!1||R.length===0)return;const ne=i.getRenderTarget(),_=i.getActiveCubeFace(),S=i.getActiveMipmapLevel(),O=i.state;O.setBlending(Kn),O.buffers.color.setClear(1,1,1,1),O.buffers.depth.setTest(!0),O.setScissorTest(!1);const k=m!==In&&this.type===In,V=m===In&&this.type!==In;for(let q=0,G=R.length;q<G;q++){const ce=R[q],K=ce.shadow;if(K===void 0){console.warn("THREE.WebGLShadowMap:",ce,"has no shadow.");continue}if(K.autoUpdate===!1&&K.needsUpdate===!1)continue;s.copy(K.mapSize);const me=K.getFrameExtents();if(s.multiply(me),r.copy(K.mapSize),(s.x>h||s.y>h)&&(s.x>h&&(r.x=Math.floor(h/me.x),s.x=r.x*me.x,K.mapSize.x=r.x),s.y>h&&(r.y=Math.floor(h/me.y),s.y=r.y*me.y,K.mapSize.y=r.y)),K.map===null||k===!0||V===!0){const ve=this.type!==In?{minFilter:rn,magFilter:rn}:{};K.map!==null&&K.map.dispose(),K.map=new Si(s.x,s.y,ve),K.map.texture.name=ce.name+".shadowMap",K.camera.updateProjectionMatrix()}i.setRenderTarget(K.map),i.clear();const xe=K.getViewportCount();for(let ve=0;ve<xe;ve++){const ie=K.getViewport(ve);a.set(r.x*ie.x,r.y*ie.y,r.x*ie.z,r.y*ie.w),O.viewport(a),K.updateMatrices(ce,ve),n=K.getFrustum(),y(C,z,K.camera,ce,this.type)}K.isPointLightShadow!==!0&&this.type===In&&w(K,z),K.needsUpdate=!1}m=this.type,f.needsUpdate=!1,i.setRenderTarget(ne,_,S)};function w(R,C){const z=e.update(x);d.defines.VSM_SAMPLES!==R.blurSamples&&(d.defines.VSM_SAMPLES=R.blurSamples,u.defines.VSM_SAMPLES=R.blurSamples,d.needsUpdate=!0,u.needsUpdate=!0),R.mapPass===null&&(R.mapPass=new Si(s.x,s.y)),d.uniforms.shadow_pass.value=R.map.texture,d.uniforms.resolution.value=R.mapSize,d.uniforms.radius.value=R.radius,i.setRenderTarget(R.mapPass),i.clear(),i.renderBufferDirect(C,null,z,d,x,null),u.uniforms.shadow_pass.value=R.mapPass.texture,u.uniforms.resolution.value=R.mapSize,u.uniforms.radius.value=R.radius,i.setRenderTarget(R.map),i.clear(),i.renderBufferDirect(C,null,z,u,x,null)}function M(R,C,z,ne){let _=null;const S=z.isPointLight===!0?R.customDistanceMaterial:R.customDepthMaterial;if(S!==void 0)_=S;else if(_=z.isPointLight===!0?c:o,i.localClippingEnabled&&C.clipShadows===!0&&Array.isArray(C.clippingPlanes)&&C.clippingPlanes.length!==0||C.displacementMap&&C.displacementScale!==0||C.alphaMap&&C.alphaTest>0||C.map&&C.alphaTest>0){const O=_.uuid,k=C.uuid;let V=l[O];V===void 0&&(V={},l[O]=V);let q=V[k];q===void 0&&(q=_.clone(),V[k]=q,C.addEventListener("dispose",L)),_=q}if(_.visible=C.visible,_.wireframe=C.wireframe,ne===In?_.side=C.shadowSide!==null?C.shadowSide:C.side:_.side=C.shadowSide!==null?C.shadowSide:p[C.side],_.alphaMap=C.alphaMap,_.alphaTest=C.alphaTest,_.map=C.map,_.clipShadows=C.clipShadows,_.clippingPlanes=C.clippingPlanes,_.clipIntersection=C.clipIntersection,_.displacementMap=C.displacementMap,_.displacementScale=C.displacementScale,_.displacementBias=C.displacementBias,_.wireframeLinewidth=C.wireframeLinewidth,_.linewidth=C.linewidth,z.isPointLight===!0&&_.isMeshDistanceMaterial===!0){const O=i.properties.get(_);O.light=z}return _}function y(R,C,z,ne,_){if(R.visible===!1)return;if(R.layers.test(C.layers)&&(R.isMesh||R.isLine||R.isPoints)&&(R.castShadow||R.receiveShadow&&_===In)&&(!R.frustumCulled||n.intersectsObject(R))){R.modelViewMatrix.multiplyMatrices(z.matrixWorldInverse,R.matrixWorld);const k=e.update(R),V=R.material;if(Array.isArray(V)){const q=k.groups;for(let G=0,ce=q.length;G<ce;G++){const K=q[G],me=V[K.materialIndex];if(me&&me.visible){const xe=M(R,me,ne,_);R.onBeforeShadow(i,R,C,z,k,xe,K),i.renderBufferDirect(z,null,k,xe,R,K),R.onAfterShadow(i,R,C,z,k,xe,K)}}}else if(V.visible){const q=M(R,V,ne,_);R.onBeforeShadow(i,R,C,z,k,q,null),i.renderBufferDirect(z,null,k,q,R,null),R.onAfterShadow(i,R,C,z,k,q,null)}}const O=R.children;for(let k=0,V=O.length;k<V;k++)y(O[k],C,z,ne,_)}function L(R){R.target.removeEventListener("dispose",L);for(const z in l){const ne=l[z],_=R.target.uuid;_ in ne&&(ne[_].dispose(),delete ne[_])}}}const l_={[oo]:co,[lo]:fo,[ho]:po,[ts]:uo,[co]:oo,[fo]:lo,[po]:ho,[uo]:ts};function h_(i){function e(){let F=!1;const Le=new vt;let se=null;const _e=new vt(0,0,0,0);return{setMask:function(Re){se!==Re&&!F&&(i.colorMask(Re,Re,Re,Re),se=Re)},setLocked:function(Re){F=Re},setClear:function(Re,Pe,Ze,Mt,Ht){Ht===!0&&(Re*=Mt,Pe*=Mt,Ze*=Mt),Le.set(Re,Pe,Ze,Mt),_e.equals(Le)===!1&&(i.clearColor(Re,Pe,Ze,Mt),_e.copy(Le))},reset:function(){F=!1,se=null,_e.set(-1,0,0,0)}}}function t(){let F=!1,Le=!1,se=null,_e=null,Re=null;return{setReversed:function(Pe){Le=Pe},setTest:function(Pe){Pe?X(i.DEPTH_TEST):Y(i.DEPTH_TEST)},setMask:function(Pe){se!==Pe&&!F&&(i.depthMask(Pe),se=Pe)},setFunc:function(Pe){if(Le&&(Pe=l_[Pe]),_e!==Pe){switch(Pe){case oo:i.depthFunc(i.NEVER);break;case co:i.depthFunc(i.ALWAYS);break;case lo:i.depthFunc(i.LESS);break;case ts:i.depthFunc(i.LEQUAL);break;case ho:i.depthFunc(i.EQUAL);break;case uo:i.depthFunc(i.GEQUAL);break;case fo:i.depthFunc(i.GREATER);break;case po:i.depthFunc(i.NOTEQUAL);break;default:i.depthFunc(i.LEQUAL)}_e=Pe}},setLocked:function(Pe){F=Pe},setClear:function(Pe){Re!==Pe&&(i.clearDepth(Pe),Re=Pe)},reset:function(){F=!1,se=null,_e=null,Re=null}}}function n(){let F=!1,Le=null,se=null,_e=null,Re=null,Pe=null,Ze=null,Mt=null,Ht=null;return{setTest:function(Je){F||(Je?X(i.STENCIL_TEST):Y(i.STENCIL_TEST))},setMask:function(Je){Le!==Je&&!F&&(i.stencilMask(Je),Le=Je)},setFunc:function(Je,Gt,bn){(se!==Je||_e!==Gt||Re!==bn)&&(i.stencilFunc(Je,Gt,bn),se=Je,_e=Gt,Re=bn)},setOp:function(Je,Gt,bn){(Pe!==Je||Ze!==Gt||Mt!==bn)&&(i.stencilOp(Je,Gt,bn),Pe=Je,Ze=Gt,Mt=bn)},setLocked:function(Je){F=Je},setClear:function(Je){Ht!==Je&&(i.clearStencil(Je),Ht=Je)},reset:function(){F=!1,Le=null,se=null,_e=null,Re=null,Pe=null,Ze=null,Mt=null,Ht=null}}}const s=new e,r=new t,a=new n,o=new WeakMap,c=new WeakMap;let l={},h={},p=new WeakMap,d=[],u=null,g=!1,x=null,f=null,m=null,w=null,M=null,y=null,L=null,R=new je(0,0,0),C=0,z=!1,ne=null,_=null,S=null,O=null,k=null;const V=i.getParameter(i.MAX_COMBINED_TEXTURE_IMAGE_UNITS);let q=!1,G=0;const ce=i.getParameter(i.VERSION);ce.indexOf("WebGL")!==-1?(G=parseFloat(/^WebGL (\d)/.exec(ce)[1]),q=G>=1):ce.indexOf("OpenGL ES")!==-1&&(G=parseFloat(/^OpenGL ES (\d)/.exec(ce)[1]),q=G>=2);let K=null,me={};const xe=i.getParameter(i.SCISSOR_BOX),ve=i.getParameter(i.VIEWPORT),ie=new vt().fromArray(xe),le=new vt().fromArray(ve);function A(F,Le,se,_e){const Re=new Uint8Array(4),Pe=i.createTexture();i.bindTexture(F,Pe),i.texParameteri(F,i.TEXTURE_MIN_FILTER,i.NEAREST),i.texParameteri(F,i.TEXTURE_MAG_FILTER,i.NEAREST);for(let Ze=0;Ze<se;Ze++)F===i.TEXTURE_3D||F===i.TEXTURE_2D_ARRAY?i.texImage3D(Le,0,i.RGBA,1,1,_e,0,i.RGBA,i.UNSIGNED_BYTE,Re):i.texImage2D(Le+Ze,0,i.RGBA,1,1,0,i.RGBA,i.UNSIGNED_BYTE,Re);return Pe}const I={};I[i.TEXTURE_2D]=A(i.TEXTURE_2D,i.TEXTURE_2D,1),I[i.TEXTURE_CUBE_MAP]=A(i.TEXTURE_CUBE_MAP,i.TEXTURE_CUBE_MAP_POSITIVE_X,6),I[i.TEXTURE_2D_ARRAY]=A(i.TEXTURE_2D_ARRAY,i.TEXTURE_2D_ARRAY,1,1),I[i.TEXTURE_3D]=A(i.TEXTURE_3D,i.TEXTURE_3D,1,1),s.setClear(0,0,0,1),r.setClear(1),a.setClear(0),X(i.DEPTH_TEST),r.setFunc(ts),re(!1),pe(jc),X(i.CULL_FACE),E(Kn);function X(F){l[F]!==!0&&(i.enable(F),l[F]=!0)}function Y(F){l[F]!==!1&&(i.disable(F),l[F]=!1)}function fe(F,Le){return h[F]!==Le?(i.bindFramebuffer(F,Le),h[F]=Le,F===i.DRAW_FRAMEBUFFER&&(h[i.FRAMEBUFFER]=Le),F===i.FRAMEBUFFER&&(h[i.DRAW_FRAMEBUFFER]=Le),!0):!1}function U(F,Le){let se=d,_e=!1;if(F){se=p.get(Le),se===void 0&&(se=[],p.set(Le,se));const Re=F.textures;if(se.length!==Re.length||se[0]!==i.COLOR_ATTACHMENT0){for(let Pe=0,Ze=Re.length;Pe<Ze;Pe++)se[Pe]=i.COLOR_ATTACHMENT0+Pe;se.length=Re.length,_e=!0}}else se[0]!==i.BACK&&(se[0]=i.BACK,_e=!0);_e&&i.drawBuffers(se)}function te(F){return u!==F?(i.useProgram(F),u=F,!0):!1}const ye={[mi]:i.FUNC_ADD,[Eu]:i.FUNC_SUBTRACT,[wu]:i.FUNC_REVERSE_SUBTRACT};ye[Tu]=i.MIN,ye[Au]=i.MAX;const de={[Ru]:i.ZERO,[Cu]:i.ONE,[Lu]:i.SRC_COLOR,[ro]:i.SRC_ALPHA,[Ou]:i.SRC_ALPHA_SATURATE,[Uu]:i.DST_COLOR,[Iu]:i.DST_ALPHA,[Pu]:i.ONE_MINUS_SRC_COLOR,[ao]:i.ONE_MINUS_SRC_ALPHA,[Nu]:i.ONE_MINUS_DST_COLOR,[Du]:i.ONE_MINUS_DST_ALPHA,[zu]:i.CONSTANT_COLOR,[Fu]:i.ONE_MINUS_CONSTANT_COLOR,[ku]:i.CONSTANT_ALPHA,[Bu]:i.ONE_MINUS_CONSTANT_ALPHA};function E(F,Le,se,_e,Re,Pe,Ze,Mt,Ht,Je){if(F===Kn){g===!0&&(Y(i.BLEND),g=!1);return}if(g===!1&&(X(i.BLEND),g=!0),F!==bu){if(F!==x||Je!==z){if((f!==mi||M!==mi)&&(i.blendEquation(i.FUNC_ADD),f=mi,M=mi),Je)switch(F){case Ji:i.blendFuncSeparate(i.ONE,i.ONE_MINUS_SRC_ALPHA,i.ONE,i.ONE_MINUS_SRC_ALPHA);break;case Xc:i.blendFunc(i.ONE,i.ONE);break;case qc:i.blendFuncSeparate(i.ZERO,i.ONE_MINUS_SRC_COLOR,i.ZERO,i.ONE);break;case $c:i.blendFuncSeparate(i.ZERO,i.SRC_COLOR,i.ZERO,i.SRC_ALPHA);break;default:console.error("THREE.WebGLState: Invalid blending: ",F);break}else switch(F){case Ji:i.blendFuncSeparate(i.SRC_ALPHA,i.ONE_MINUS_SRC_ALPHA,i.ONE,i.ONE_MINUS_SRC_ALPHA);break;case Xc:i.blendFunc(i.SRC_ALPHA,i.ONE);break;case qc:i.blendFuncSeparate(i.ZERO,i.ONE_MINUS_SRC_COLOR,i.ZERO,i.ONE);break;case $c:i.blendFunc(i.ZERO,i.SRC_COLOR);break;default:console.error("THREE.WebGLState: Invalid blending: ",F);break}m=null,w=null,y=null,L=null,R.set(0,0,0),C=0,x=F,z=Je}return}Re=Re||Le,Pe=Pe||se,Ze=Ze||_e,(Le!==f||Re!==M)&&(i.blendEquationSeparate(ye[Le],ye[Re]),f=Le,M=Re),(se!==m||_e!==w||Pe!==y||Ze!==L)&&(i.blendFuncSeparate(de[se],de[_e],de[Pe],de[Ze]),m=se,w=_e,y=Pe,L=Ze),(Mt.equals(R)===!1||Ht!==C)&&(i.blendColor(Mt.r,Mt.g,Mt.b,Ht),R.copy(Mt),C=Ht),x=F,z=!1}function B(F,Le){F.side===jt?Y(i.CULL_FACE):X(i.CULL_FACE);let se=F.side===Xt;Le&&(se=!se),re(se),F.blending===Ji&&F.transparent===!1?E(Kn):E(F.blending,F.blendEquation,F.blendSrc,F.blendDst,F.blendEquationAlpha,F.blendSrcAlpha,F.blendDstAlpha,F.blendColor,F.blendAlpha,F.premultipliedAlpha),r.setFunc(F.depthFunc),r.setTest(F.depthTest),r.setMask(F.depthWrite),s.setMask(F.colorWrite);const _e=F.stencilWrite;a.setTest(_e),_e&&(a.setMask(F.stencilWriteMask),a.setFunc(F.stencilFunc,F.stencilRef,F.stencilFuncMask),a.setOp(F.stencilFail,F.stencilZFail,F.stencilZPass)),De(F.polygonOffset,F.polygonOffsetFactor,F.polygonOffsetUnits),F.alphaToCoverage===!0?X(i.SAMPLE_ALPHA_TO_COVERAGE):Y(i.SAMPLE_ALPHA_TO_COVERAGE)}function re(F){ne!==F&&(F?i.frontFace(i.CW):i.frontFace(i.CCW),ne=F)}function pe(F){F!==yu?(X(i.CULL_FACE),F!==_&&(F===jc?i.cullFace(i.BACK):F===Mu?i.cullFace(i.FRONT):i.cullFace(i.FRONT_AND_BACK))):Y(i.CULL_FACE),_=F}function ge(F){F!==S&&(q&&i.lineWidth(F),S=F)}function De(F,Le,se){F?(X(i.POLYGON_OFFSET_FILL),(O!==Le||k!==se)&&(i.polygonOffset(Le,se),O=Le,k=se)):Y(i.POLYGON_OFFSET_FILL)}function he(F){F?X(i.SCISSOR_TEST):Y(i.SCISSOR_TEST)}function b(F){F===void 0&&(F=i.TEXTURE0+V-1),K!==F&&(i.activeTexture(F),K=F)}function v(F,Le,se){se===void 0&&(K===null?se=i.TEXTURE0+V-1:se=K);let _e=me[se];_e===void 0&&(_e={type:void 0,texture:void 0},me[se]=_e),(_e.type!==F||_e.texture!==Le)&&(K!==se&&(i.activeTexture(se),K=se),i.bindTexture(F,Le||I[F]),_e.type=F,_e.texture=Le)}function N(){const F=me[K];F!==void 0&&F.type!==void 0&&(i.bindTexture(F.type,null),F.type=void 0,F.texture=void 0)}function J(){try{i.compressedTexImage2D.apply(i,arguments)}catch(F){console.error("THREE.WebGLState:",F)}}function oe(){try{i.compressedTexImage3D.apply(i,arguments)}catch(F){console.error("THREE.WebGLState:",F)}}function ae(){try{i.texSubImage2D.apply(i,arguments)}catch(F){console.error("THREE.WebGLState:",F)}}function Ae(){try{i.texSubImage3D.apply(i,arguments)}catch(F){console.error("THREE.WebGLState:",F)}}function be(){try{i.compressedTexSubImage2D.apply(i,arguments)}catch(F){console.error("THREE.WebGLState:",F)}}function we(){try{i.compressedTexSubImage3D.apply(i,arguments)}catch(F){console.error("THREE.WebGLState:",F)}}function qe(){try{i.texStorage2D.apply(i,arguments)}catch(F){console.error("THREE.WebGLState:",F)}}function Me(){try{i.texStorage3D.apply(i,arguments)}catch(F){console.error("THREE.WebGLState:",F)}}function Ie(){try{i.texImage2D.apply(i,arguments)}catch(F){console.error("THREE.WebGLState:",F)}}function He(){try{i.texImage3D.apply(i,arguments)}catch(F){console.error("THREE.WebGLState:",F)}}function We(F){ie.equals(F)===!1&&(i.scissor(F.x,F.y,F.z,F.w),ie.copy(F))}function Ue(F){le.equals(F)===!1&&(i.viewport(F.x,F.y,F.z,F.w),le.copy(F))}function Ke(F,Le){let se=c.get(Le);se===void 0&&(se=new WeakMap,c.set(Le,se));let _e=se.get(F);_e===void 0&&(_e=i.getUniformBlockIndex(Le,F.name),se.set(F,_e))}function Xe(F,Le){const _e=c.get(Le).get(F);o.get(Le)!==_e&&(i.uniformBlockBinding(Le,_e,F.__bindingPointIndex),o.set(Le,_e))}function ot(){i.disable(i.BLEND),i.disable(i.CULL_FACE),i.disable(i.DEPTH_TEST),i.disable(i.POLYGON_OFFSET_FILL),i.disable(i.SCISSOR_TEST),i.disable(i.STENCIL_TEST),i.disable(i.SAMPLE_ALPHA_TO_COVERAGE),i.blendEquation(i.FUNC_ADD),i.blendFunc(i.ONE,i.ZERO),i.blendFuncSeparate(i.ONE,i.ZERO,i.ONE,i.ZERO),i.blendColor(0,0,0,0),i.colorMask(!0,!0,!0,!0),i.clearColor(0,0,0,0),i.depthMask(!0),i.depthFunc(i.LESS),i.clearDepth(1),i.stencilMask(4294967295),i.stencilFunc(i.ALWAYS,0,4294967295),i.stencilOp(i.KEEP,i.KEEP,i.KEEP),i.clearStencil(0),i.cullFace(i.BACK),i.frontFace(i.CCW),i.polygonOffset(0,0),i.activeTexture(i.TEXTURE0),i.bindFramebuffer(i.FRAMEBUFFER,null),i.bindFramebuffer(i.DRAW_FRAMEBUFFER,null),i.bindFramebuffer(i.READ_FRAMEBUFFER,null),i.useProgram(null),i.lineWidth(1),i.scissor(0,0,i.canvas.width,i.canvas.height),i.viewport(0,0,i.canvas.width,i.canvas.height),l={},K=null,me={},h={},p=new WeakMap,d=[],u=null,g=!1,x=null,f=null,m=null,w=null,M=null,y=null,L=null,R=new je(0,0,0),C=0,z=!1,ne=null,_=null,S=null,O=null,k=null,ie.set(0,0,i.canvas.width,i.canvas.height),le.set(0,0,i.canvas.width,i.canvas.height),s.reset(),r.reset(),a.reset()}return{buffers:{color:s,depth:r,stencil:a},enable:X,disable:Y,bindFramebuffer:fe,drawBuffers:U,useProgram:te,setBlending:E,setMaterial:B,setFlipSided:re,setCullFace:pe,setLineWidth:ge,setPolygonOffset:De,setScissorTest:he,activeTexture:b,bindTexture:v,unbindTexture:N,compressedTexImage2D:J,compressedTexImage3D:oe,texImage2D:Ie,texImage3D:He,updateUBOMapping:Ke,uniformBlockBinding:Xe,texStorage2D:qe,texStorage3D:Me,texSubImage2D:ae,texSubImage3D:Ae,compressedTexSubImage2D:be,compressedTexSubImage3D:we,scissor:We,viewport:Ue,reset:ot}}function zl(i,e,t,n){const s=d_(n);switch(t){case Fh:return i*e;case Bh:return i*e;case Hh:return i*e*2;case Gh:return i*e/s.components*s.byteLength;case oc:return i*e/s.components*s.byteLength;case Vh:return i*e*2/s.components*s.byteLength;case cc:return i*e*2/s.components*s.byteLength;case kh:return i*e*3/s.components*s.byteLength;case pn:return i*e*4/s.components*s.byteLength;case lc:return i*e*4/s.components*s.byteLength;case Er:case wr:return Math.floor((i+3)/4)*Math.floor((e+3)/4)*8;case Tr:case Ar:return Math.floor((i+3)/4)*Math.floor((e+3)/4)*16;case yo:case So:return Math.max(i,16)*Math.max(e,8)/4;case xo:case Mo:return Math.max(i,8)*Math.max(e,8)/2;case bo:case Eo:return Math.floor((i+3)/4)*Math.floor((e+3)/4)*8;case wo:return Math.floor((i+3)/4)*Math.floor((e+3)/4)*16;case To:return Math.floor((i+3)/4)*Math.floor((e+3)/4)*16;case Ao:return Math.floor((i+4)/5)*Math.floor((e+3)/4)*16;case Ro:return Math.floor((i+4)/5)*Math.floor((e+4)/5)*16;case Co:return Math.floor((i+5)/6)*Math.floor((e+4)/5)*16;case Lo:return Math.floor((i+5)/6)*Math.floor((e+5)/6)*16;case Po:return Math.floor((i+7)/8)*Math.floor((e+4)/5)*16;case Io:return Math.floor((i+7)/8)*Math.floor((e+5)/6)*16;case Do:return Math.floor((i+7)/8)*Math.floor((e+7)/8)*16;case Uo:return Math.floor((i+9)/10)*Math.floor((e+4)/5)*16;case No:return Math.floor((i+9)/10)*Math.floor((e+5)/6)*16;case Oo:return Math.floor((i+9)/10)*Math.floor((e+7)/8)*16;case zo:return Math.floor((i+9)/10)*Math.floor((e+9)/10)*16;case Fo:return Math.floor((i+11)/12)*Math.floor((e+9)/10)*16;case ko:return Math.floor((i+11)/12)*Math.floor((e+11)/12)*16;case Rr:case Bo:case Ho:return Math.ceil(i/4)*Math.ceil(e/4)*16;case Wh:case Go:return Math.ceil(i/4)*Math.ceil(e/4)*8;case Vo:case Wo:return Math.ceil(i/4)*Math.ceil(e/4)*16}throw new Error(`Unable to determine texture byte length for ${t} format.`)}function d_(i){switch(i){case zn:case Nh:return{byteLength:1,components:1};case Ps:case Oh:case Fs:return{byteLength:2,components:1};case rc:case ac:return{byteLength:2,components:4};case Mi:case sc:case Dn:return{byteLength:4,components:1};case zh:return{byteLength:4,components:3}}throw new Error(`Unknown texture type ${i}.`)}function u_(i,e,t,n,s,r,a){const o=e.has("WEBGL_multisampled_render_to_texture")?e.get("WEBGL_multisampled_render_to_texture"):null,c=typeof navigator>"u"?!1:/OculusBrowser/g.test(navigator.userAgent),l=new ke,h=new WeakMap;let p;const d=new WeakMap;let u=!1;try{u=typeof OffscreenCanvas<"u"&&new OffscreenCanvas(1,1).getContext("2d")!==null}catch{}function g(b,v){return u?new OffscreenCanvas(b,v):Wr("canvas")}function x(b,v,N){let J=1;const oe=he(b);if((oe.width>N||oe.height>N)&&(J=N/Math.max(oe.width,oe.height)),J<1)if(typeof HTMLImageElement<"u"&&b instanceof HTMLImageElement||typeof HTMLCanvasElement<"u"&&b instanceof HTMLCanvasElement||typeof ImageBitmap<"u"&&b instanceof ImageBitmap||typeof VideoFrame<"u"&&b instanceof VideoFrame){const ae=Math.floor(J*oe.width),Ae=Math.floor(J*oe.height);p===void 0&&(p=g(ae,Ae));const be=v?g(ae,Ae):p;return be.width=ae,be.height=Ae,be.getContext("2d").drawImage(b,0,0,ae,Ae),console.warn("THREE.WebGLRenderer: Texture has been resized from ("+oe.width+"x"+oe.height+") to ("+ae+"x"+Ae+")."),be}else return"data"in b&&console.warn("THREE.WebGLRenderer: Image in DataTexture is too big ("+oe.width+"x"+oe.height+")."),b;return b}function f(b){return b.generateMipmaps&&b.minFilter!==rn&&b.minFilter!==nn}function m(b){i.generateMipmap(b)}function w(b,v,N,J,oe=!1){if(b!==null){if(i[b]!==void 0)return i[b];console.warn("THREE.WebGLRenderer: Attempt to use non-existing WebGL internal format '"+b+"'")}let ae=v;if(v===i.RED&&(N===i.FLOAT&&(ae=i.R32F),N===i.HALF_FLOAT&&(ae=i.R16F),N===i.UNSIGNED_BYTE&&(ae=i.R8)),v===i.RED_INTEGER&&(N===i.UNSIGNED_BYTE&&(ae=i.R8UI),N===i.UNSIGNED_SHORT&&(ae=i.R16UI),N===i.UNSIGNED_INT&&(ae=i.R32UI),N===i.BYTE&&(ae=i.R8I),N===i.SHORT&&(ae=i.R16I),N===i.INT&&(ae=i.R32I)),v===i.RG&&(N===i.FLOAT&&(ae=i.RG32F),N===i.HALF_FLOAT&&(ae=i.RG16F),N===i.UNSIGNED_BYTE&&(ae=i.RG8)),v===i.RG_INTEGER&&(N===i.UNSIGNED_BYTE&&(ae=i.RG8UI),N===i.UNSIGNED_SHORT&&(ae=i.RG16UI),N===i.UNSIGNED_INT&&(ae=i.RG32UI),N===i.BYTE&&(ae=i.RG8I),N===i.SHORT&&(ae=i.RG16I),N===i.INT&&(ae=i.RG32I)),v===i.RGB_INTEGER&&(N===i.UNSIGNED_BYTE&&(ae=i.RGB8UI),N===i.UNSIGNED_SHORT&&(ae=i.RGB16UI),N===i.UNSIGNED_INT&&(ae=i.RGB32UI),N===i.BYTE&&(ae=i.RGB8I),N===i.SHORT&&(ae=i.RGB16I),N===i.INT&&(ae=i.RGB32I)),v===i.RGBA_INTEGER&&(N===i.UNSIGNED_BYTE&&(ae=i.RGBA8UI),N===i.UNSIGNED_SHORT&&(ae=i.RGBA16UI),N===i.UNSIGNED_INT&&(ae=i.RGBA32UI),N===i.BYTE&&(ae=i.RGBA8I),N===i.SHORT&&(ae=i.RGBA16I),N===i.INT&&(ae=i.RGBA32I)),v===i.RGB&&N===i.UNSIGNED_INT_5_9_9_9_REV&&(ae=i.RGB9_E5),v===i.RGBA){const Ae=oe?Br:tt.getTransfer(J);N===i.FLOAT&&(ae=i.RGBA32F),N===i.HALF_FLOAT&&(ae=i.RGBA16F),N===i.UNSIGNED_BYTE&&(ae=Ae===ht?i.SRGB8_ALPHA8:i.RGBA8),N===i.UNSIGNED_SHORT_4_4_4_4&&(ae=i.RGBA4),N===i.UNSIGNED_SHORT_5_5_5_1&&(ae=i.RGB5_A1)}return(ae===i.R16F||ae===i.R32F||ae===i.RG16F||ae===i.RG32F||ae===i.RGBA16F||ae===i.RGBA32F)&&e.get("EXT_color_buffer_float"),ae}function M(b,v){let N;return b?v===null||v===Mi||v===ss?N=i.DEPTH24_STENCIL8:v===Dn?N=i.DEPTH32F_STENCIL8:v===Ps&&(N=i.DEPTH24_STENCIL8,console.warn("DepthTexture: 16 bit depth attachment is not supported with stencil. Using 24-bit attachment.")):v===null||v===Mi||v===ss?N=i.DEPTH_COMPONENT24:v===Dn?N=i.DEPTH_COMPONENT32F:v===Ps&&(N=i.DEPTH_COMPONENT16),N}function y(b,v){return f(b)===!0||b.isFramebufferTexture&&b.minFilter!==rn&&b.minFilter!==nn?Math.log2(Math.max(v.width,v.height))+1:b.mipmaps!==void 0&&b.mipmaps.length>0?b.mipmaps.length:b.isCompressedTexture&&Array.isArray(b.image)?v.mipmaps.length:1}function L(b){const v=b.target;v.removeEventListener("dispose",L),C(v),v.isVideoTexture&&h.delete(v)}function R(b){const v=b.target;v.removeEventListener("dispose",R),ne(v)}function C(b){const v=n.get(b);if(v.__webglInit===void 0)return;const N=b.source,J=d.get(N);if(J){const oe=J[v.__cacheKey];oe.usedTimes--,oe.usedTimes===0&&z(b),Object.keys(J).length===0&&d.delete(N)}n.remove(b)}function z(b){const v=n.get(b);i.deleteTexture(v.__webglTexture);const N=b.source,J=d.get(N);delete J[v.__cacheKey],a.memory.textures--}function ne(b){const v=n.get(b);if(b.depthTexture&&b.depthTexture.dispose(),b.isWebGLCubeRenderTarget)for(let J=0;J<6;J++){if(Array.isArray(v.__webglFramebuffer[J]))for(let oe=0;oe<v.__webglFramebuffer[J].length;oe++)i.deleteFramebuffer(v.__webglFramebuffer[J][oe]);else i.deleteFramebuffer(v.__webglFramebuffer[J]);v.__webglDepthbuffer&&i.deleteRenderbuffer(v.__webglDepthbuffer[J])}else{if(Array.isArray(v.__webglFramebuffer))for(let J=0;J<v.__webglFramebuffer.length;J++)i.deleteFramebuffer(v.__webglFramebuffer[J]);else i.deleteFramebuffer(v.__webglFramebuffer);if(v.__webglDepthbuffer&&i.deleteRenderbuffer(v.__webglDepthbuffer),v.__webglMultisampledFramebuffer&&i.deleteFramebuffer(v.__webglMultisampledFramebuffer),v.__webglColorRenderbuffer)for(let J=0;J<v.__webglColorRenderbuffer.length;J++)v.__webglColorRenderbuffer[J]&&i.deleteRenderbuffer(v.__webglColorRenderbuffer[J]);v.__webglDepthRenderbuffer&&i.deleteRenderbuffer(v.__webglDepthRenderbuffer)}const N=b.textures;for(let J=0,oe=N.length;J<oe;J++){const ae=n.get(N[J]);ae.__webglTexture&&(i.deleteTexture(ae.__webglTexture),a.memory.textures--),n.remove(N[J])}n.remove(b)}let _=0;function S(){_=0}function O(){const b=_;return b>=s.maxTextures&&console.warn("THREE.WebGLTextures: Trying to use "+b+" texture units while this GPU supports only "+s.maxTextures),_+=1,b}function k(b){const v=[];return v.push(b.wrapS),v.push(b.wrapT),v.push(b.wrapR||0),v.push(b.magFilter),v.push(b.minFilter),v.push(b.anisotropy),v.push(b.internalFormat),v.push(b.format),v.push(b.type),v.push(b.generateMipmaps),v.push(b.premultiplyAlpha),v.push(b.flipY),v.push(b.unpackAlignment),v.push(b.colorSpace),v.join()}function V(b,v){const N=n.get(b);if(b.isVideoTexture&&ge(b),b.isRenderTargetTexture===!1&&b.version>0&&N.__version!==b.version){const J=b.image;if(J===null)console.warn("THREE.WebGLRenderer: Texture marked for update but no image data found.");else if(J.complete===!1)console.warn("THREE.WebGLRenderer: Texture marked for update but image is incomplete");else{le(N,b,v);return}}t.bindTexture(i.TEXTURE_2D,N.__webglTexture,i.TEXTURE0+v)}function q(b,v){const N=n.get(b);if(b.version>0&&N.__version!==b.version){le(N,b,v);return}t.bindTexture(i.TEXTURE_2D_ARRAY,N.__webglTexture,i.TEXTURE0+v)}function G(b,v){const N=n.get(b);if(b.version>0&&N.__version!==b.version){le(N,b,v);return}t.bindTexture(i.TEXTURE_3D,N.__webglTexture,i.TEXTURE0+v)}function ce(b,v){const N=n.get(b);if(b.version>0&&N.__version!==b.version){A(N,b,v);return}t.bindTexture(i.TEXTURE_CUBE_MAP,N.__webglTexture,i.TEXTURE0+v)}const K={[_o]:i.REPEAT,[vi]:i.CLAMP_TO_EDGE,[vo]:i.MIRRORED_REPEAT},me={[rn]:i.NEAREST,[Ku]:i.NEAREST_MIPMAP_NEAREST,[Xs]:i.NEAREST_MIPMAP_LINEAR,[nn]:i.LINEAR,[_a]:i.LINEAR_MIPMAP_NEAREST,[xi]:i.LINEAR_MIPMAP_LINEAR},xe={[ef]:i.NEVER,[of]:i.ALWAYS,[tf]:i.LESS,[Xh]:i.LEQUAL,[nf]:i.EQUAL,[af]:i.GEQUAL,[sf]:i.GREATER,[rf]:i.NOTEQUAL};function ve(b,v){if(v.type===Dn&&e.has("OES_texture_float_linear")===!1&&(v.magFilter===nn||v.magFilter===_a||v.magFilter===Xs||v.magFilter===xi||v.minFilter===nn||v.minFilter===_a||v.minFilter===Xs||v.minFilter===xi)&&console.warn("THREE.WebGLRenderer: Unable to use linear filtering with floating point textures. OES_texture_float_linear not supported on this device."),i.texParameteri(b,i.TEXTURE_WRAP_S,K[v.wrapS]),i.texParameteri(b,i.TEXTURE_WRAP_T,K[v.wrapT]),(b===i.TEXTURE_3D||b===i.TEXTURE_2D_ARRAY)&&i.texParameteri(b,i.TEXTURE_WRAP_R,K[v.wrapR]),i.texParameteri(b,i.TEXTURE_MAG_FILTER,me[v.magFilter]),i.texParameteri(b,i.TEXTURE_MIN_FILTER,me[v.minFilter]),v.compareFunction&&(i.texParameteri(b,i.TEXTURE_COMPARE_MODE,i.COMPARE_REF_TO_TEXTURE),i.texParameteri(b,i.TEXTURE_COMPARE_FUNC,xe[v.compareFunction])),e.has("EXT_texture_filter_anisotropic")===!0){if(v.magFilter===rn||v.minFilter!==Xs&&v.minFilter!==xi||v.type===Dn&&e.has("OES_texture_float_linear")===!1)return;if(v.anisotropy>1||n.get(v).__currentAnisotropy){const N=e.get("EXT_texture_filter_anisotropic");i.texParameterf(b,N.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(v.anisotropy,s.getMaxAnisotropy())),n.get(v).__currentAnisotropy=v.anisotropy}}}function ie(b,v){let N=!1;b.__webglInit===void 0&&(b.__webglInit=!0,v.addEventListener("dispose",L));const J=v.source;let oe=d.get(J);oe===void 0&&(oe={},d.set(J,oe));const ae=k(v);if(ae!==b.__cacheKey){oe[ae]===void 0&&(oe[ae]={texture:i.createTexture(),usedTimes:0},a.memory.textures++,N=!0),oe[ae].usedTimes++;const Ae=oe[b.__cacheKey];Ae!==void 0&&(oe[b.__cacheKey].usedTimes--,Ae.usedTimes===0&&z(v)),b.__cacheKey=ae,b.__webglTexture=oe[ae].texture}return N}function le(b,v,N){let J=i.TEXTURE_2D;(v.isDataArrayTexture||v.isCompressedArrayTexture)&&(J=i.TEXTURE_2D_ARRAY),v.isData3DTexture&&(J=i.TEXTURE_3D);const oe=ie(b,v),ae=v.source;t.bindTexture(J,b.__webglTexture,i.TEXTURE0+N);const Ae=n.get(ae);if(ae.version!==Ae.__version||oe===!0){t.activeTexture(i.TEXTURE0+N);const be=tt.getPrimaries(tt.workingColorSpace),we=v.colorSpace===Yn?null:tt.getPrimaries(v.colorSpace),qe=v.colorSpace===Yn||be===we?i.NONE:i.BROWSER_DEFAULT_WEBGL;i.pixelStorei(i.UNPACK_FLIP_Y_WEBGL,v.flipY),i.pixelStorei(i.UNPACK_PREMULTIPLY_ALPHA_WEBGL,v.premultiplyAlpha),i.pixelStorei(i.UNPACK_ALIGNMENT,v.unpackAlignment),i.pixelStorei(i.UNPACK_COLORSPACE_CONVERSION_WEBGL,qe);let Me=x(v.image,!1,s.maxTextureSize);Me=De(v,Me);const Ie=r.convert(v.format,v.colorSpace),He=r.convert(v.type);let We=w(v.internalFormat,Ie,He,v.colorSpace,v.isVideoTexture);ve(J,v);let Ue;const Ke=v.mipmaps,Xe=v.isVideoTexture!==!0,ot=Ae.__version===void 0||oe===!0,F=ae.dataReady,Le=y(v,Me);if(v.isDepthTexture)We=M(v.format===rs,v.type),ot&&(Xe?t.texStorage2D(i.TEXTURE_2D,1,We,Me.width,Me.height):t.texImage2D(i.TEXTURE_2D,0,We,Me.width,Me.height,0,Ie,He,null));else if(v.isDataTexture)if(Ke.length>0){Xe&&ot&&t.texStorage2D(i.TEXTURE_2D,Le,We,Ke[0].width,Ke[0].height);for(let se=0,_e=Ke.length;se<_e;se++)Ue=Ke[se],Xe?F&&t.texSubImage2D(i.TEXTURE_2D,se,0,0,Ue.width,Ue.height,Ie,He,Ue.data):t.texImage2D(i.TEXTURE_2D,se,We,Ue.width,Ue.height,0,Ie,He,Ue.data);v.generateMipmaps=!1}else Xe?(ot&&t.texStorage2D(i.TEXTURE_2D,Le,We,Me.width,Me.height),F&&t.texSubImage2D(i.TEXTURE_2D,0,0,0,Me.width,Me.height,Ie,He,Me.data)):t.texImage2D(i.TEXTURE_2D,0,We,Me.width,Me.height,0,Ie,He,Me.data);else if(v.isCompressedTexture)if(v.isCompressedArrayTexture){Xe&&ot&&t.texStorage3D(i.TEXTURE_2D_ARRAY,Le,We,Ke[0].width,Ke[0].height,Me.depth);for(let se=0,_e=Ke.length;se<_e;se++)if(Ue=Ke[se],v.format!==pn)if(Ie!==null)if(Xe){if(F)if(v.layerUpdates.size>0){const Re=zl(Ue.width,Ue.height,v.format,v.type);for(const Pe of v.layerUpdates){const Ze=Ue.data.subarray(Pe*Re/Ue.data.BYTES_PER_ELEMENT,(Pe+1)*Re/Ue.data.BYTES_PER_ELEMENT);t.compressedTexSubImage3D(i.TEXTURE_2D_ARRAY,se,0,0,Pe,Ue.width,Ue.height,1,Ie,Ze,0,0)}v.clearLayerUpdates()}else t.compressedTexSubImage3D(i.TEXTURE_2D_ARRAY,se,0,0,0,Ue.width,Ue.height,Me.depth,Ie,Ue.data,0,0)}else t.compressedTexImage3D(i.TEXTURE_2D_ARRAY,se,We,Ue.width,Ue.height,Me.depth,0,Ue.data,0,0);else console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()");else Xe?F&&t.texSubImage3D(i.TEXTURE_2D_ARRAY,se,0,0,0,Ue.width,Ue.height,Me.depth,Ie,He,Ue.data):t.texImage3D(i.TEXTURE_2D_ARRAY,se,We,Ue.width,Ue.height,Me.depth,0,Ie,He,Ue.data)}else{Xe&&ot&&t.texStorage2D(i.TEXTURE_2D,Le,We,Ke[0].width,Ke[0].height);for(let se=0,_e=Ke.length;se<_e;se++)Ue=Ke[se],v.format!==pn?Ie!==null?Xe?F&&t.compressedTexSubImage2D(i.TEXTURE_2D,se,0,0,Ue.width,Ue.height,Ie,Ue.data):t.compressedTexImage2D(i.TEXTURE_2D,se,We,Ue.width,Ue.height,0,Ue.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):Xe?F&&t.texSubImage2D(i.TEXTURE_2D,se,0,0,Ue.width,Ue.height,Ie,He,Ue.data):t.texImage2D(i.TEXTURE_2D,se,We,Ue.width,Ue.height,0,Ie,He,Ue.data)}else if(v.isDataArrayTexture)if(Xe){if(ot&&t.texStorage3D(i.TEXTURE_2D_ARRAY,Le,We,Me.width,Me.height,Me.depth),F)if(v.layerUpdates.size>0){const se=zl(Me.width,Me.height,v.format,v.type);for(const _e of v.layerUpdates){const Re=Me.data.subarray(_e*se/Me.data.BYTES_PER_ELEMENT,(_e+1)*se/Me.data.BYTES_PER_ELEMENT);t.texSubImage3D(i.TEXTURE_2D_ARRAY,0,0,0,_e,Me.width,Me.height,1,Ie,He,Re)}v.clearLayerUpdates()}else t.texSubImage3D(i.TEXTURE_2D_ARRAY,0,0,0,0,Me.width,Me.height,Me.depth,Ie,He,Me.data)}else t.texImage3D(i.TEXTURE_2D_ARRAY,0,We,Me.width,Me.height,Me.depth,0,Ie,He,Me.data);else if(v.isData3DTexture)Xe?(ot&&t.texStorage3D(i.TEXTURE_3D,Le,We,Me.width,Me.height,Me.depth),F&&t.texSubImage3D(i.TEXTURE_3D,0,0,0,0,Me.width,Me.height,Me.depth,Ie,He,Me.data)):t.texImage3D(i.TEXTURE_3D,0,We,Me.width,Me.height,Me.depth,0,Ie,He,Me.data);else if(v.isFramebufferTexture){if(ot)if(Xe)t.texStorage2D(i.TEXTURE_2D,Le,We,Me.width,Me.height);else{let se=Me.width,_e=Me.height;for(let Re=0;Re<Le;Re++)t.texImage2D(i.TEXTURE_2D,Re,We,se,_e,0,Ie,He,null),se>>=1,_e>>=1}}else if(Ke.length>0){if(Xe&&ot){const se=he(Ke[0]);t.texStorage2D(i.TEXTURE_2D,Le,We,se.width,se.height)}for(let se=0,_e=Ke.length;se<_e;se++)Ue=Ke[se],Xe?F&&t.texSubImage2D(i.TEXTURE_2D,se,0,0,Ie,He,Ue):t.texImage2D(i.TEXTURE_2D,se,We,Ie,He,Ue);v.generateMipmaps=!1}else if(Xe){if(ot){const se=he(Me);t.texStorage2D(i.TEXTURE_2D,Le,We,se.width,se.height)}F&&t.texSubImage2D(i.TEXTURE_2D,0,0,0,Ie,He,Me)}else t.texImage2D(i.TEXTURE_2D,0,We,Ie,He,Me);f(v)&&m(J),Ae.__version=ae.version,v.onUpdate&&v.onUpdate(v)}b.__version=v.version}function A(b,v,N){if(v.image.length!==6)return;const J=ie(b,v),oe=v.source;t.bindTexture(i.TEXTURE_CUBE_MAP,b.__webglTexture,i.TEXTURE0+N);const ae=n.get(oe);if(oe.version!==ae.__version||J===!0){t.activeTexture(i.TEXTURE0+N);const Ae=tt.getPrimaries(tt.workingColorSpace),be=v.colorSpace===Yn?null:tt.getPrimaries(v.colorSpace),we=v.colorSpace===Yn||Ae===be?i.NONE:i.BROWSER_DEFAULT_WEBGL;i.pixelStorei(i.UNPACK_FLIP_Y_WEBGL,v.flipY),i.pixelStorei(i.UNPACK_PREMULTIPLY_ALPHA_WEBGL,v.premultiplyAlpha),i.pixelStorei(i.UNPACK_ALIGNMENT,v.unpackAlignment),i.pixelStorei(i.UNPACK_COLORSPACE_CONVERSION_WEBGL,we);const qe=v.isCompressedTexture||v.image[0].isCompressedTexture,Me=v.image[0]&&v.image[0].isDataTexture,Ie=[];for(let _e=0;_e<6;_e++)!qe&&!Me?Ie[_e]=x(v.image[_e],!0,s.maxCubemapSize):Ie[_e]=Me?v.image[_e].image:v.image[_e],Ie[_e]=De(v,Ie[_e]);const He=Ie[0],We=r.convert(v.format,v.colorSpace),Ue=r.convert(v.type),Ke=w(v.internalFormat,We,Ue,v.colorSpace),Xe=v.isVideoTexture!==!0,ot=ae.__version===void 0||J===!0,F=oe.dataReady;let Le=y(v,He);ve(i.TEXTURE_CUBE_MAP,v);let se;if(qe){Xe&&ot&&t.texStorage2D(i.TEXTURE_CUBE_MAP,Le,Ke,He.width,He.height);for(let _e=0;_e<6;_e++){se=Ie[_e].mipmaps;for(let Re=0;Re<se.length;Re++){const Pe=se[Re];v.format!==pn?We!==null?Xe?F&&t.compressedTexSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+_e,Re,0,0,Pe.width,Pe.height,We,Pe.data):t.compressedTexImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+_e,Re,Ke,Pe.width,Pe.height,0,Pe.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()"):Xe?F&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+_e,Re,0,0,Pe.width,Pe.height,We,Ue,Pe.data):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+_e,Re,Ke,Pe.width,Pe.height,0,We,Ue,Pe.data)}}}else{if(se=v.mipmaps,Xe&&ot){se.length>0&&Le++;const _e=he(Ie[0]);t.texStorage2D(i.TEXTURE_CUBE_MAP,Le,Ke,_e.width,_e.height)}for(let _e=0;_e<6;_e++)if(Me){Xe?F&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+_e,0,0,0,Ie[_e].width,Ie[_e].height,We,Ue,Ie[_e].data):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+_e,0,Ke,Ie[_e].width,Ie[_e].height,0,We,Ue,Ie[_e].data);for(let Re=0;Re<se.length;Re++){const Ze=se[Re].image[_e].image;Xe?F&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+_e,Re+1,0,0,Ze.width,Ze.height,We,Ue,Ze.data):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+_e,Re+1,Ke,Ze.width,Ze.height,0,We,Ue,Ze.data)}}else{Xe?F&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+_e,0,0,0,We,Ue,Ie[_e]):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+_e,0,Ke,We,Ue,Ie[_e]);for(let Re=0;Re<se.length;Re++){const Pe=se[Re];Xe?F&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+_e,Re+1,0,0,We,Ue,Pe.image[_e]):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+_e,Re+1,Ke,We,Ue,Pe.image[_e])}}}f(v)&&m(i.TEXTURE_CUBE_MAP),ae.__version=oe.version,v.onUpdate&&v.onUpdate(v)}b.__version=v.version}function I(b,v,N,J,oe,ae){const Ae=r.convert(N.format,N.colorSpace),be=r.convert(N.type),we=w(N.internalFormat,Ae,be,N.colorSpace);if(!n.get(v).__hasExternalTextures){const Me=Math.max(1,v.width>>ae),Ie=Math.max(1,v.height>>ae);oe===i.TEXTURE_3D||oe===i.TEXTURE_2D_ARRAY?t.texImage3D(oe,ae,we,Me,Ie,v.depth,0,Ae,be,null):t.texImage2D(oe,ae,we,Me,Ie,0,Ae,be,null)}t.bindFramebuffer(i.FRAMEBUFFER,b),pe(v)?o.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,J,oe,n.get(N).__webglTexture,0,re(v)):(oe===i.TEXTURE_2D||oe>=i.TEXTURE_CUBE_MAP_POSITIVE_X&&oe<=i.TEXTURE_CUBE_MAP_NEGATIVE_Z)&&i.framebufferTexture2D(i.FRAMEBUFFER,J,oe,n.get(N).__webglTexture,ae),t.bindFramebuffer(i.FRAMEBUFFER,null)}function X(b,v,N){if(i.bindRenderbuffer(i.RENDERBUFFER,b),v.depthBuffer){const J=v.depthTexture,oe=J&&J.isDepthTexture?J.type:null,ae=M(v.stencilBuffer,oe),Ae=v.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,be=re(v);pe(v)?o.renderbufferStorageMultisampleEXT(i.RENDERBUFFER,be,ae,v.width,v.height):N?i.renderbufferStorageMultisample(i.RENDERBUFFER,be,ae,v.width,v.height):i.renderbufferStorage(i.RENDERBUFFER,ae,v.width,v.height),i.framebufferRenderbuffer(i.FRAMEBUFFER,Ae,i.RENDERBUFFER,b)}else{const J=v.textures;for(let oe=0;oe<J.length;oe++){const ae=J[oe],Ae=r.convert(ae.format,ae.colorSpace),be=r.convert(ae.type),we=w(ae.internalFormat,Ae,be,ae.colorSpace),qe=re(v);N&&pe(v)===!1?i.renderbufferStorageMultisample(i.RENDERBUFFER,qe,we,v.width,v.height):pe(v)?o.renderbufferStorageMultisampleEXT(i.RENDERBUFFER,qe,we,v.width,v.height):i.renderbufferStorage(i.RENDERBUFFER,we,v.width,v.height)}}i.bindRenderbuffer(i.RENDERBUFFER,null)}function Y(b,v){if(v&&v.isWebGLCubeRenderTarget)throw new Error("Depth Texture with cube render targets is not supported");if(t.bindFramebuffer(i.FRAMEBUFFER,b),!(v.depthTexture&&v.depthTexture.isDepthTexture))throw new Error("renderTarget.depthTexture must be an instance of THREE.DepthTexture");(!n.get(v.depthTexture).__webglTexture||v.depthTexture.image.width!==v.width||v.depthTexture.image.height!==v.height)&&(v.depthTexture.image.width=v.width,v.depthTexture.image.height=v.height,v.depthTexture.needsUpdate=!0),V(v.depthTexture,0);const J=n.get(v.depthTexture).__webglTexture,oe=re(v);if(v.depthTexture.format===Qi)pe(v)?o.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,i.DEPTH_ATTACHMENT,i.TEXTURE_2D,J,0,oe):i.framebufferTexture2D(i.FRAMEBUFFER,i.DEPTH_ATTACHMENT,i.TEXTURE_2D,J,0);else if(v.depthTexture.format===rs)pe(v)?o.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,i.DEPTH_STENCIL_ATTACHMENT,i.TEXTURE_2D,J,0,oe):i.framebufferTexture2D(i.FRAMEBUFFER,i.DEPTH_STENCIL_ATTACHMENT,i.TEXTURE_2D,J,0);else throw new Error("Unknown depthTexture format")}function fe(b){const v=n.get(b),N=b.isWebGLCubeRenderTarget===!0;if(v.__boundDepthTexture!==b.depthTexture){const J=b.depthTexture;if(v.__depthDisposeCallback&&v.__depthDisposeCallback(),J){const oe=()=>{delete v.__boundDepthTexture,delete v.__depthDisposeCallback,J.removeEventListener("dispose",oe)};J.addEventListener("dispose",oe),v.__depthDisposeCallback=oe}v.__boundDepthTexture=J}if(b.depthTexture&&!v.__autoAllocateDepthBuffer){if(N)throw new Error("target.depthTexture not supported in Cube render targets");Y(v.__webglFramebuffer,b)}else if(N){v.__webglDepthbuffer=[];for(let J=0;J<6;J++)if(t.bindFramebuffer(i.FRAMEBUFFER,v.__webglFramebuffer[J]),v.__webglDepthbuffer[J]===void 0)v.__webglDepthbuffer[J]=i.createRenderbuffer(),X(v.__webglDepthbuffer[J],b,!1);else{const oe=b.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,ae=v.__webglDepthbuffer[J];i.bindRenderbuffer(i.RENDERBUFFER,ae),i.framebufferRenderbuffer(i.FRAMEBUFFER,oe,i.RENDERBUFFER,ae)}}else if(t.bindFramebuffer(i.FRAMEBUFFER,v.__webglFramebuffer),v.__webglDepthbuffer===void 0)v.__webglDepthbuffer=i.createRenderbuffer(),X(v.__webglDepthbuffer,b,!1);else{const J=b.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,oe=v.__webglDepthbuffer;i.bindRenderbuffer(i.RENDERBUFFER,oe),i.framebufferRenderbuffer(i.FRAMEBUFFER,J,i.RENDERBUFFER,oe)}t.bindFramebuffer(i.FRAMEBUFFER,null)}function U(b,v,N){const J=n.get(b);v!==void 0&&I(J.__webglFramebuffer,b,b.texture,i.COLOR_ATTACHMENT0,i.TEXTURE_2D,0),N!==void 0&&fe(b)}function te(b){const v=b.texture,N=n.get(b),J=n.get(v);b.addEventListener("dispose",R);const oe=b.textures,ae=b.isWebGLCubeRenderTarget===!0,Ae=oe.length>1;if(Ae||(J.__webglTexture===void 0&&(J.__webglTexture=i.createTexture()),J.__version=v.version,a.memory.textures++),ae){N.__webglFramebuffer=[];for(let be=0;be<6;be++)if(v.mipmaps&&v.mipmaps.length>0){N.__webglFramebuffer[be]=[];for(let we=0;we<v.mipmaps.length;we++)N.__webglFramebuffer[be][we]=i.createFramebuffer()}else N.__webglFramebuffer[be]=i.createFramebuffer()}else{if(v.mipmaps&&v.mipmaps.length>0){N.__webglFramebuffer=[];for(let be=0;be<v.mipmaps.length;be++)N.__webglFramebuffer[be]=i.createFramebuffer()}else N.__webglFramebuffer=i.createFramebuffer();if(Ae)for(let be=0,we=oe.length;be<we;be++){const qe=n.get(oe[be]);qe.__webglTexture===void 0&&(qe.__webglTexture=i.createTexture(),a.memory.textures++)}if(b.samples>0&&pe(b)===!1){N.__webglMultisampledFramebuffer=i.createFramebuffer(),N.__webglColorRenderbuffer=[],t.bindFramebuffer(i.FRAMEBUFFER,N.__webglMultisampledFramebuffer);for(let be=0;be<oe.length;be++){const we=oe[be];N.__webglColorRenderbuffer[be]=i.createRenderbuffer(),i.bindRenderbuffer(i.RENDERBUFFER,N.__webglColorRenderbuffer[be]);const qe=r.convert(we.format,we.colorSpace),Me=r.convert(we.type),Ie=w(we.internalFormat,qe,Me,we.colorSpace,b.isXRRenderTarget===!0),He=re(b);i.renderbufferStorageMultisample(i.RENDERBUFFER,He,Ie,b.width,b.height),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+be,i.RENDERBUFFER,N.__webglColorRenderbuffer[be])}i.bindRenderbuffer(i.RENDERBUFFER,null),b.depthBuffer&&(N.__webglDepthRenderbuffer=i.createRenderbuffer(),X(N.__webglDepthRenderbuffer,b,!0)),t.bindFramebuffer(i.FRAMEBUFFER,null)}}if(ae){t.bindTexture(i.TEXTURE_CUBE_MAP,J.__webglTexture),ve(i.TEXTURE_CUBE_MAP,v);for(let be=0;be<6;be++)if(v.mipmaps&&v.mipmaps.length>0)for(let we=0;we<v.mipmaps.length;we++)I(N.__webglFramebuffer[be][we],b,v,i.COLOR_ATTACHMENT0,i.TEXTURE_CUBE_MAP_POSITIVE_X+be,we);else I(N.__webglFramebuffer[be],b,v,i.COLOR_ATTACHMENT0,i.TEXTURE_CUBE_MAP_POSITIVE_X+be,0);f(v)&&m(i.TEXTURE_CUBE_MAP),t.unbindTexture()}else if(Ae){for(let be=0,we=oe.length;be<we;be++){const qe=oe[be],Me=n.get(qe);t.bindTexture(i.TEXTURE_2D,Me.__webglTexture),ve(i.TEXTURE_2D,qe),I(N.__webglFramebuffer,b,qe,i.COLOR_ATTACHMENT0+be,i.TEXTURE_2D,0),f(qe)&&m(i.TEXTURE_2D)}t.unbindTexture()}else{let be=i.TEXTURE_2D;if((b.isWebGL3DRenderTarget||b.isWebGLArrayRenderTarget)&&(be=b.isWebGL3DRenderTarget?i.TEXTURE_3D:i.TEXTURE_2D_ARRAY),t.bindTexture(be,J.__webglTexture),ve(be,v),v.mipmaps&&v.mipmaps.length>0)for(let we=0;we<v.mipmaps.length;we++)I(N.__webglFramebuffer[we],b,v,i.COLOR_ATTACHMENT0,be,we);else I(N.__webglFramebuffer,b,v,i.COLOR_ATTACHMENT0,be,0);f(v)&&m(be),t.unbindTexture()}b.depthBuffer&&fe(b)}function ye(b){const v=b.textures;for(let N=0,J=v.length;N<J;N++){const oe=v[N];if(f(oe)){const ae=b.isWebGLCubeRenderTarget?i.TEXTURE_CUBE_MAP:i.TEXTURE_2D,Ae=n.get(oe).__webglTexture;t.bindTexture(ae,Ae),m(ae),t.unbindTexture()}}}const de=[],E=[];function B(b){if(b.samples>0){if(pe(b)===!1){const v=b.textures,N=b.width,J=b.height;let oe=i.COLOR_BUFFER_BIT;const ae=b.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,Ae=n.get(b),be=v.length>1;if(be)for(let we=0;we<v.length;we++)t.bindFramebuffer(i.FRAMEBUFFER,Ae.__webglMultisampledFramebuffer),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+we,i.RENDERBUFFER,null),t.bindFramebuffer(i.FRAMEBUFFER,Ae.__webglFramebuffer),i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0+we,i.TEXTURE_2D,null,0);t.bindFramebuffer(i.READ_FRAMEBUFFER,Ae.__webglMultisampledFramebuffer),t.bindFramebuffer(i.DRAW_FRAMEBUFFER,Ae.__webglFramebuffer);for(let we=0;we<v.length;we++){if(b.resolveDepthBuffer&&(b.depthBuffer&&(oe|=i.DEPTH_BUFFER_BIT),b.stencilBuffer&&b.resolveStencilBuffer&&(oe|=i.STENCIL_BUFFER_BIT)),be){i.framebufferRenderbuffer(i.READ_FRAMEBUFFER,i.COLOR_ATTACHMENT0,i.RENDERBUFFER,Ae.__webglColorRenderbuffer[we]);const qe=n.get(v[we]).__webglTexture;i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0,i.TEXTURE_2D,qe,0)}i.blitFramebuffer(0,0,N,J,0,0,N,J,oe,i.NEAREST),c===!0&&(de.length=0,E.length=0,de.push(i.COLOR_ATTACHMENT0+we),b.depthBuffer&&b.resolveDepthBuffer===!1&&(de.push(ae),E.push(ae),i.invalidateFramebuffer(i.DRAW_FRAMEBUFFER,E)),i.invalidateFramebuffer(i.READ_FRAMEBUFFER,de))}if(t.bindFramebuffer(i.READ_FRAMEBUFFER,null),t.bindFramebuffer(i.DRAW_FRAMEBUFFER,null),be)for(let we=0;we<v.length;we++){t.bindFramebuffer(i.FRAMEBUFFER,Ae.__webglMultisampledFramebuffer),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+we,i.RENDERBUFFER,Ae.__webglColorRenderbuffer[we]);const qe=n.get(v[we]).__webglTexture;t.bindFramebuffer(i.FRAMEBUFFER,Ae.__webglFramebuffer),i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0+we,i.TEXTURE_2D,qe,0)}t.bindFramebuffer(i.DRAW_FRAMEBUFFER,Ae.__webglMultisampledFramebuffer)}else if(b.depthBuffer&&b.resolveDepthBuffer===!1&&c){const v=b.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT;i.invalidateFramebuffer(i.DRAW_FRAMEBUFFER,[v])}}}function re(b){return Math.min(s.maxSamples,b.samples)}function pe(b){const v=n.get(b);return b.samples>0&&e.has("WEBGL_multisampled_render_to_texture")===!0&&v.__useRenderToTexture!==!1}function ge(b){const v=a.render.frame;h.get(b)!==v&&(h.set(b,v),b.update())}function De(b,v){const N=b.colorSpace,J=b.format,oe=b.type;return b.isCompressedTexture===!0||b.isVideoTexture===!0||N!==ni&&N!==Yn&&(tt.getTransfer(N)===ht?(J!==pn||oe!==zn)&&console.warn("THREE.WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType."):console.error("THREE.WebGLTextures: Unsupported texture color space:",N)),v}function he(b){return typeof HTMLImageElement<"u"&&b instanceof HTMLImageElement?(l.width=b.naturalWidth||b.width,l.height=b.naturalHeight||b.height):typeof VideoFrame<"u"&&b instanceof VideoFrame?(l.width=b.displayWidth,l.height=b.displayHeight):(l.width=b.width,l.height=b.height),l}this.allocateTextureUnit=O,this.resetTextureUnits=S,this.setTexture2D=V,this.setTexture2DArray=q,this.setTexture3D=G,this.setTextureCube=ce,this.rebindTextures=U,this.setupRenderTarget=te,this.updateRenderTargetMipmap=ye,this.updateMultisampleRenderTarget=B,this.setupDepthRenderbuffer=fe,this.setupFrameBufferTexture=I,this.useMultisampledRTT=pe}function f_(i,e){function t(n,s=Yn){let r;const a=tt.getTransfer(s);if(n===zn)return i.UNSIGNED_BYTE;if(n===rc)return i.UNSIGNED_SHORT_4_4_4_4;if(n===ac)return i.UNSIGNED_SHORT_5_5_5_1;if(n===zh)return i.UNSIGNED_INT_5_9_9_9_REV;if(n===Nh)return i.BYTE;if(n===Oh)return i.SHORT;if(n===Ps)return i.UNSIGNED_SHORT;if(n===sc)return i.INT;if(n===Mi)return i.UNSIGNED_INT;if(n===Dn)return i.FLOAT;if(n===Fs)return i.HALF_FLOAT;if(n===Fh)return i.ALPHA;if(n===kh)return i.RGB;if(n===pn)return i.RGBA;if(n===Bh)return i.LUMINANCE;if(n===Hh)return i.LUMINANCE_ALPHA;if(n===Qi)return i.DEPTH_COMPONENT;if(n===rs)return i.DEPTH_STENCIL;if(n===Gh)return i.RED;if(n===oc)return i.RED_INTEGER;if(n===Vh)return i.RG;if(n===cc)return i.RG_INTEGER;if(n===lc)return i.RGBA_INTEGER;if(n===Er||n===wr||n===Tr||n===Ar)if(a===ht)if(r=e.get("WEBGL_compressed_texture_s3tc_srgb"),r!==null){if(n===Er)return r.COMPRESSED_SRGB_S3TC_DXT1_EXT;if(n===wr)return r.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;if(n===Tr)return r.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;if(n===Ar)return r.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT}else return null;else if(r=e.get("WEBGL_compressed_texture_s3tc"),r!==null){if(n===Er)return r.COMPRESSED_RGB_S3TC_DXT1_EXT;if(n===wr)return r.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(n===Tr)return r.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(n===Ar)return r.COMPRESSED_RGBA_S3TC_DXT5_EXT}else return null;if(n===xo||n===yo||n===Mo||n===So)if(r=e.get("WEBGL_compressed_texture_pvrtc"),r!==null){if(n===xo)return r.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;if(n===yo)return r.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;if(n===Mo)return r.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;if(n===So)return r.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG}else return null;if(n===bo||n===Eo||n===wo)if(r=e.get("WEBGL_compressed_texture_etc"),r!==null){if(n===bo||n===Eo)return a===ht?r.COMPRESSED_SRGB8_ETC2:r.COMPRESSED_RGB8_ETC2;if(n===wo)return a===ht?r.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:r.COMPRESSED_RGBA8_ETC2_EAC}else return null;if(n===To||n===Ao||n===Ro||n===Co||n===Lo||n===Po||n===Io||n===Do||n===Uo||n===No||n===Oo||n===zo||n===Fo||n===ko)if(r=e.get("WEBGL_compressed_texture_astc"),r!==null){if(n===To)return a===ht?r.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:r.COMPRESSED_RGBA_ASTC_4x4_KHR;if(n===Ao)return a===ht?r.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:r.COMPRESSED_RGBA_ASTC_5x4_KHR;if(n===Ro)return a===ht?r.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:r.COMPRESSED_RGBA_ASTC_5x5_KHR;if(n===Co)return a===ht?r.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:r.COMPRESSED_RGBA_ASTC_6x5_KHR;if(n===Lo)return a===ht?r.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:r.COMPRESSED_RGBA_ASTC_6x6_KHR;if(n===Po)return a===ht?r.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:r.COMPRESSED_RGBA_ASTC_8x5_KHR;if(n===Io)return a===ht?r.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:r.COMPRESSED_RGBA_ASTC_8x6_KHR;if(n===Do)return a===ht?r.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:r.COMPRESSED_RGBA_ASTC_8x8_KHR;if(n===Uo)return a===ht?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:r.COMPRESSED_RGBA_ASTC_10x5_KHR;if(n===No)return a===ht?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:r.COMPRESSED_RGBA_ASTC_10x6_KHR;if(n===Oo)return a===ht?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:r.COMPRESSED_RGBA_ASTC_10x8_KHR;if(n===zo)return a===ht?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:r.COMPRESSED_RGBA_ASTC_10x10_KHR;if(n===Fo)return a===ht?r.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:r.COMPRESSED_RGBA_ASTC_12x10_KHR;if(n===ko)return a===ht?r.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:r.COMPRESSED_RGBA_ASTC_12x12_KHR}else return null;if(n===Rr||n===Bo||n===Ho)if(r=e.get("EXT_texture_compression_bptc"),r!==null){if(n===Rr)return a===ht?r.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT:r.COMPRESSED_RGBA_BPTC_UNORM_EXT;if(n===Bo)return r.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;if(n===Ho)return r.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT}else return null;if(n===Wh||n===Go||n===Vo||n===Wo)if(r=e.get("EXT_texture_compression_rgtc"),r!==null){if(n===Rr)return r.COMPRESSED_RED_RGTC1_EXT;if(n===Go)return r.COMPRESSED_SIGNED_RED_RGTC1_EXT;if(n===Vo)return r.COMPRESSED_RED_GREEN_RGTC2_EXT;if(n===Wo)return r.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT}else return null;return n===ss?i.UNSIGNED_INT_24_8:i[n]!==void 0?i[n]:null}return{convert:t}}class p_ extends kt{constructor(e=[]){super(),this.isArrayCamera=!0,this.cameras=e}}class mn extends xt{constructor(){super(),this.isGroup=!0,this.type="Group"}}const m_={type:"move"};class Xa{constructor(){this._targetRay=null,this._grip=null,this._hand=null}getHandSpace(){return this._hand===null&&(this._hand=new mn,this._hand.matrixAutoUpdate=!1,this._hand.visible=!1,this._hand.joints={},this._hand.inputState={pinching:!1}),this._hand}getTargetRaySpace(){return this._targetRay===null&&(this._targetRay=new mn,this._targetRay.matrixAutoUpdate=!1,this._targetRay.visible=!1,this._targetRay.hasLinearVelocity=!1,this._targetRay.linearVelocity=new D,this._targetRay.hasAngularVelocity=!1,this._targetRay.angularVelocity=new D),this._targetRay}getGripSpace(){return this._grip===null&&(this._grip=new mn,this._grip.matrixAutoUpdate=!1,this._grip.visible=!1,this._grip.hasLinearVelocity=!1,this._grip.linearVelocity=new D,this._grip.hasAngularVelocity=!1,this._grip.angularVelocity=new D),this._grip}dispatchEvent(e){return this._targetRay!==null&&this._targetRay.dispatchEvent(e),this._grip!==null&&this._grip.dispatchEvent(e),this._hand!==null&&this._hand.dispatchEvent(e),this}connect(e){if(e&&e.hand){const t=this._hand;if(t)for(const n of e.hand.values())this._getHandJoint(t,n)}return this.dispatchEvent({type:"connected",data:e}),this}disconnect(e){return this.dispatchEvent({type:"disconnected",data:e}),this._targetRay!==null&&(this._targetRay.visible=!1),this._grip!==null&&(this._grip.visible=!1),this._hand!==null&&(this._hand.visible=!1),this}update(e,t,n){let s=null,r=null,a=null;const o=this._targetRay,c=this._grip,l=this._hand;if(e&&t.session.visibilityState!=="visible-blurred"){if(l&&e.hand){a=!0;for(const x of e.hand.values()){const f=t.getJointPose(x,n),m=this._getHandJoint(l,x);f!==null&&(m.matrix.fromArray(f.transform.matrix),m.matrix.decompose(m.position,m.rotation,m.scale),m.matrixWorldNeedsUpdate=!0,m.jointRadius=f.radius),m.visible=f!==null}const h=l.joints["index-finger-tip"],p=l.joints["thumb-tip"],d=h.position.distanceTo(p.position),u=.02,g=.005;l.inputState.pinching&&d>u+g?(l.inputState.pinching=!1,this.dispatchEvent({type:"pinchend",handedness:e.handedness,target:this})):!l.inputState.pinching&&d<=u-g&&(l.inputState.pinching=!0,this.dispatchEvent({type:"pinchstart",handedness:e.handedness,target:this}))}else c!==null&&e.gripSpace&&(r=t.getPose(e.gripSpace,n),r!==null&&(c.matrix.fromArray(r.transform.matrix),c.matrix.decompose(c.position,c.rotation,c.scale),c.matrixWorldNeedsUpdate=!0,r.linearVelocity?(c.hasLinearVelocity=!0,c.linearVelocity.copy(r.linearVelocity)):c.hasLinearVelocity=!1,r.angularVelocity?(c.hasAngularVelocity=!0,c.angularVelocity.copy(r.angularVelocity)):c.hasAngularVelocity=!1));o!==null&&(s=t.getPose(e.targetRaySpace,n),s===null&&r!==null&&(s=r),s!==null&&(o.matrix.fromArray(s.transform.matrix),o.matrix.decompose(o.position,o.rotation,o.scale),o.matrixWorldNeedsUpdate=!0,s.linearVelocity?(o.hasLinearVelocity=!0,o.linearVelocity.copy(s.linearVelocity)):o.hasLinearVelocity=!1,s.angularVelocity?(o.hasAngularVelocity=!0,o.angularVelocity.copy(s.angularVelocity)):o.hasAngularVelocity=!1,this.dispatchEvent(m_)))}return o!==null&&(o.visible=s!==null),c!==null&&(c.visible=r!==null),l!==null&&(l.visible=a!==null),this}_getHandJoint(e,t){if(e.joints[t.jointName]===void 0){const n=new mn;n.matrixAutoUpdate=!1,n.visible=!1,e.joints[t.jointName]=n,e.add(n)}return e.joints[t.jointName]}}const g_=`
void main() {
...
`;let xe;try{xe=JSON.parse(me)}catch{continue}const ve=((_=(ne=xe==null?void 0:xe.choices)==null?void 0:ne[0])==null?void 0:_.delta)??{};typeof ve.content=="string"?(g+=ve.content,w(g)):x&&w(x);const ie=(S=ve.tool_calls)==null?void 0:S[0];(O=ie==null?void 0:ie.function)!=null&&O.arguments&&(x+=ie.function.arguments,g||w(x))}}const M=f.trim()||g||x;if(!M)throw new Error("模型未返回任何内容");if(console.log("[agent] AI raw response ->",M),!x){const q=g.trim();if(!q)throw new Error("模型未返回任何内容");return{message:q,usedLLM:!0,raw:M}}let y;try{y=JSON.parse(x)}catch{throw new Error(`模型未返回合法的 JSON（收到：${x.slice(0,80)}）`)}const L=g.trim()||(typeof(y==null?void 0:y.description)=="string"?y.description.trim():"");if((y==null?void 0:y.update)===!1)return{message:L||"需要更多信息后再修改（未更新数据）。",usedLLM:!0,raw:M};const R=_d((y==null?void 0:y.root)??y,{i:0});if(!R.children.length&&R.shape==="box"&&R.size.x===1&&R.size.y===1)throw new Error("模型未返回有效的元件结构");const C=Rs(typeof(y==null?void 0:y.name)=="string"?y.name:((k=e==null?void 0:e.asset)==null?void 0:k.name)??"AI Component",yc.includes(y==null?void 0:y.category)?y.category:((V=e==null?void 0:e.asset)==null?void 0:V.category)??"other");return C.root=R,C.description=typeof(y==null?void 0:y.description)=="string"?y.description:`由 AI 生成：${i}`,{message:L||`已更新「${C.name}」`,asset:C,usedLLM:!0,raw:M}}async function rv(i,e,t){const n=Us();if(!n.enabled||!n.apiKey)return Q_();try{return await vd(i,e,t)}catch(s){return{message:`AI 调用失败：${s.message}`,usedLLM:!0}}}async function av(i,e,t){const n=Us();if(!n.enabled||!n.apiKey)return{message:"未启用 AI，跳过可视化验证。",usedLLM:!1};try{return await vd("",{asset:i},t,{images:[e],verify:!0})}catch(s){return{message:`AI 验证失败：${s.message}`,usedLLM:!0}}}const ov="shape-craft:chat-history:",rh=100;function cv(i){const e=ov+i;let t=[],n=0;try{const r=localStorage.getItem(e),a=r?JSON.parse(r):[];Array.isArray(a)&&(t=a.filter(o=>typeof o=="string"))}catch{}n=t.length;const s=()=>{try{localStorage.setItem(e,JSON.stringify(t))}catch{}};return{push(r){t.push(r),t.length>rh&&(t=t.slice(-rh)),s(),n=t.length},prev(){return n<=0?null:(n--,t[n])},next(){return n<t.length-1?(n++,t[n]):(n=t.length,"")},reset(){n=t.length}}}async function lv(i,e){var le;const t=document.createElement("div");t.className="page editor-page",t.appendChild(Fn("library")),i.appendChild(t);let n,s=e;if(e){const A=await zs(e);if(!A){t.innerHTML+='<p class="empty">未找到该元件。</p>';return}n=A}else n=Rs("Untitled","other");const r=document.createElement("div");r.className="editor-layout";const a=document.createElement("div");a.className="panel hierarchy";const o=document.createElement("div");o.className="panel viewport-panel";const c=document.createElement("div");c.className="panel inspector",r.append(a,o,c),t.appendChild(r);const l=document.createElement("div");l.className="toolbar",l.innerHTML=`
  ...
  `,o.appendChild(l);let h=[],p=null;const d=l.querySelector("[data-ref-search]"),u=l.querySelector("[data-ref-list]");function g(A){const I=A.trim().toLowerCase(),X=h.filter(Y=>!I||Y.name.toLowerCase().includes(I)||Y.category.toLowerCase().includes(I));X.length?u.innerHTML=X.slice(0,8).map(Y=>`<div class="ref-item${Y.id===p?" active":""}" data-ref-id="${Y.id}">${Y.name} · ${Y.category}</div>`).join(""):u.innerHTML='<div class="ref-empty">无匹配元件</div>',u.hidden=!1}d.addEventListener("focus",async()=>{h.length||await ce(),g(d.value)}),d.addEventListener("input",()=>{p=null,g(d.value)}),d.addEventListener("keydown",A=>{if(A.key==="Enter"){const I=u.querySelector(".ref-item");I&&I.click()}else A.key==="Escape"&&(u.hidden=!0)}),t.addEventListener("click",A=>{l.querySelector("[data-ref-combo]").contains(A.target)||(u.hidden=!0)});const x=document.createElement("div");x.className="viewport-host",o.appendChild(x);const f=new md(x,A=>R(A),(A,I)=>C(A,I)),m=xc(x),w=document.createElement("div");w.className="editor-topbar",w.innerHTML=`
  ...
  `,t.insertBefore(w,r),a.addEventListener("click",A=>{const I=A.target.closest(".row-del");if(!I)return;const X=I.getAttribute("data-del-id");X&&(Dr(n.root,X),L===X&&(L=null),G())});function M(){a.innerHTML='<h4>层级结构</h4><div class="tree"></div>',a.querySelector(".tree").appendChild(y(n.root,!0))}function y(A,I){const X=document.createElement("div");X.className="tree-row"+(f.getSelectedId()===A.id?" selected":"");const Y=A.shape==="instance"?'<span class="lock" title="实例引用（整体锁定）">🔒</span>':"";X.innerHTML=`<span class="dot ${A.shape}"></span><span class="pname">${A.name}</span><span class="pshape">${A.shape}</span>${Y}<button class="row-del" title="删除该部件及其子级" data-del-id="${A.id}">×</button>`,X.addEventListener("click",U=>{U.target.classList.contains("row-del")||R(A.id)});const fe=document.createElement("div");if(fe.appendChild(X),A.children.length){const U=document.createElement("div");U.className="tree-kids";for(const te of A.children)U.appendChild(y(te,!1));fe.appendChild(U)}return I&&fe.classList.add("root-node"),fe}let L=null;function R(A){L=A,f.setSelected(A),M(),ne()}function C(A,I){const X=Nn(n.root,A);X&&(X.position=I.position,X.rotation=I.rotation,X.scale=I.scale,ne())}function z(){c.innerHTML='<h4>属性</h4><div class="inspector-body"></div><h4 class="chat-title">聊天建造</h4><div class="chat"></div>',V(c.querySelector(".chat"),`asset:${s??"new"}`),ne()}function ne(){const A=c.querySelector(".inspector-body"),I=L?Nn(n.root,L):null;A.innerHTML="",I?A.appendChild(O(I)):A.innerHTML='<p class="muted">在视图或层级中选中一个部件以编辑其变换与材质。</p>'}function _(A,I,X){const Y=document.createElement("label");Y.className="field",Y.innerHTML=`<span>${A}</span>`;const fe=document.createElement("input");return fe.type="number",fe.step="0.1",fe.value=String(I),fe.addEventListener("input",()=>X(parseFloat(fe.value)||0)),Y.appendChild(fe),Y}function S(A,I,X){const Y=document.createElement("div");Y.className="vec3";const fe=["X","Y","Z"];return["x","y","z"].forEach((U,te)=>{Y.appendChild(_(`${A} ${fe[te]}`,I[U],ye=>X({...I,[U]:ye})))}),Y}function O(A){if(A.shape==="instance")return k(A);const I=document.createElement("div");I.className="inspector-form";const X=document.createElement("label");X.className="field full",X.innerHTML="<span>名称</span>";const Y=document.createElement("input");Y.value=A.name,Y.addEventListener("input",()=>{A.name=Y.value,M()}),X.appendChild(Y),I.appendChild(X);const fe=document.createElement("label");fe.className="field full",fe.innerHTML="<span>形状</span>";const U=document.createElement("select");["box","sphere","cylinder","cone","plane","triangle","node"].forEach(re=>{const pe=document.createElement("option");pe.value=re,pe.textContent=re,re===A.shape&&(pe.selected=!0),U.appendChild(pe)}),U.addEventListener("change",()=>{A.shape=U.value,q()}),fe.appendChild(U),I.appendChild(fe);const te=(re,pe,ge)=>{const De=document.createElement("div");return De.className="group",De.innerHTML=`<div class="group-title">${re}</div>`,De.appendChild(S(re,pe,ge)),De};I.appendChild(te("尺寸 Size",A.size,re=>{A.size=re,q()})),I.appendChild(te("位置 Position",A.position,re=>{A.position=re,q()})),I.appendChild(te("旋转 Rotation (rad)",A.rotation,re=>{A.rotation=re,q()})),I.appendChild(te("缩放 Scale",A.scale,re=>{A.scale=re,q()}));const ye=document.createElement("div");ye.className="group",ye.innerHTML='<div class="group-title">材质 Material</div>';const de=document.createElement("label");de.className="field",de.innerHTML="<span>颜色</span>";const E=document.createElement("input");E.type="color",E.value=A.material.color,E.addEventListener("input",()=>{A.material.color=E.value,q()}),de.appendChild(E),ye.appendChild(de),ye.appendChild(_("Roughness",A.material.roughness,re=>{A.material.roughness=ah(re),q()})),ye.appendChild(_("Metalness",A.material.metalness,re=>{A.material.metalness=ah(re),q()})),I.appendChild(ye);const B=document.createElement("button");return B.className="btn small danger full",B.textContent="删除此部件",B.addEventListener("click",()=>{Dr(n.root,A.id),L=null,G()}),I.appendChild(B),I}function k(A){const I=document.createElement("div");I.className="inspector-form",I.innerHTML=`
      <div class="group">
    ...
    `;const X=I.querySelector(".inst-name");X.addEventListener("input",()=>{A.name=X.value,M()});const Y=document.createElement("a");Y.className="btn small full",Y.textContent="打开原件编辑器 →",Y.href=`#/editor/${A.refId}`,I.appendChild(Y);const fe=document.createElement("button");return fe.className="btn small danger full",fe.textContent="删除此引用",fe.addEventListener("click",()=>{Dr(n.root,A.id),L=null,G()}),I.appendChild(fe),I}function V(A,I){A.innerHTML=`
  ...
  `,l.appendChild(p);const d=document.createElement("div");d.className="viewport-host",l.appendChild(d);const u=new md(d,U=>_(U),(U,te)=>S(U,te)),g=new wd(u.getRootGroup());g.setClips(L()),u.onFrame(U=>g.update(U));const x=xc(d),f=document.createElement("div");f.className="editor-topbar",f.innerHTML=`
    <a class="btn small" href="#/library">← 返回</a>
    ...
    <span class="save-state"></span>
  `,n.insertBefore(f,o);let m=null,w=null;const M=new Set;let y=null;function L(){return s.animClips||(s.animClips=Ov(vh[a])),s.animClips}function R(){g.setClips(L()),g.rebind(u.getRootGroup()),w&&g.play(w)}function C(){const U=[],te=ye=>{ye.shape==="node"&&U.push(ye.name),ye.children.forEach(te)};return te(s.root),U}c.addEventListener("click",U=>{const te=U.target.closest(".row-del");if(!te)return;const ye=te.getAttribute("data-del-id");ye&&(Nr(s.root,ye),m===ye&&(m=null),ve())});function z(){c.innerHTML='<h4>骨架层级</h4><div class="tree"></div>',c.querySelector(".tree").appendChild(ne(s.root,!0))}function ne(U,te){const ye=document.createElement("div");ye.className="tree-row"+(u.getSelectedId()===U.id?" selected":"");const de=U.shape==="instance"?'<span class="lock" title="实例引用（整体锁定）">🔒</span>':"";ye.innerHTML=`<span class="dot ${U.shape}"></span><span class="pname">${U.name}</span><span class="pshape">${U.shape}</span>${de}<button class="row-del" title="删除" data-del-id="${U.id}">×</button>`,ye.addEventListener("click",B=>{B.target.classList.contains("row-del")||_(U.id)});const E=document.createElement("div");if(E.appendChild(ye),U.children.length){const B=document.createElement("div");B.className="tree-kids";for(const re of U.children)B.appendChild(ne(re,!1));E.appendChild(B)}return te&&E.classList.add("root-node"),E}function _(U){m=U,u.setSelected(U),z(),V()}function S(U,te){const ye=Nn(s.root,U);ye&&(ye.position=te.position,ye.rotation=te.rotation,ye.scale=te.scale,V())}function O(){h.innerHTML=`
      <h4>动画 Animation</h4>
      <div class="anim-panel"></div>
      <h4>属性 Inspector</h4>
      <div class="inspector-body"></div>
    `,k(h.querySelector(".anim-panel")),V()}function k(U){const te=L(),ye=C(),de=b=>Math.round(b*180/Math.PI),E=(b,v,N,J)=>`<span class="kf-dot${y&&y.clip===b&&y.track===v&&y.kf===J?" selected":""}" style="left:${(N.t*100).toFixed(2)}%" data-kf="${b}:${v}:${J}" title="t=${N.t.toFixed(2)} · ${de(N.value)}°"></span>`,B=(b,v,N)=>`
      <div class="track-row">
        <span class="track-label" title="${v.joint}">${v.joint}·${v.axis}</span>
        <div class="timeline" data-timeline="${b}:${N}">
          ${v.keyframes.map((J,oe)=>E(b,N,J,oe)).join("")}
          <span class="tl-zero">0</span><span class="tl-one">1</span>
        </div>
        <button class="row-del" title="删除轨道" data-del-track="${b}:${N}">×</button>
      </div>`,re=b=>{if(!y||y.clip!==b)return"";const v=te[b].tracks[y.track],N=v.keyframes[y.kf];return`<div class="kf-editor">
      ...
      <div class="clip-body">
        ...
        ${re(b)}
      </div>`,ge=te.map((b,v)=>{const N=!M.has(v);return`
    ...
    `,U.querySelectorAll("[data-play-clip]").forEach(b=>b.addEventListener("click",()=>{const v=Number(b.getAttribute("data-play-clip")),N=L()[v];N&&(w=N.name,g.play(N.name),U.querySelectorAll(".clip-card").forEach(J=>J.classList.remove("active")),b.closest(".clip-card").classList.add("active"),U.querySelector("[data-play]").textContent="⏸ 暂停")})),U.querySelector("[data-play]").addEventListener("click",b=>{const v=b.target,N=!g.isPlaying();g.setPlaying(N),v.textContent=N?"⏸ 暂停":"▶ 播放"});const De=U.querySelector("[data-speed]");De.addEventListener("input",()=>g.setSpeed(parseFloat(De.value)||1));const he=U.querySelector("[data-yaw]");he.addEventListener("input",()=>{const b=parseFloat(he.value)*Math.PI/180;u.getRootGroup().rotation.y=b}),U.querySelectorAll("[data-clip-label]").forEach(b=>b.addEventListener("input",()=>{L()[Number(b.getAttribute("data-clip-label"))].label=b.value})),U.querySelectorAll("[data-clip-name]").forEach(b=>b.addEventListener("input",()=>{L()[Number(b.getAttribute("data-clip-name"))].name=b.value})),U.querySelectorAll("[data-clip-dur]").forEach(b=>b.addEventListener("input",()=>{const v=Number(b.getAttribute("data-clip-dur"));L()[v].duration=Math.max(.1,parseFloat(b.value)||1),R()})),U.querySelectorAll("[data-timeline]").forEach(b=>b.addEventListener("pointerdown",v=>{v.preventDefault();const[N,J]=b.getAttribute("data-timeline").split(":").map(Number),oe=v.target.closest(".kf-dot");let ae;if(oe)ae=Number(oe.getAttribute("data-kf").split(":")[2]);else{const we=b.getBoundingClientRect(),qe=Math.min(1,Math.max(0,(v.clientX-we.left)/we.width)),Me=L()[N].tracks[J].keyframes;Me.push({t:qe,value:0}),ae=Me.length-1}y={clip:N,track:J,kf:ae};const Ae=we=>{const qe=U.querySelector(`[data-timeline="${N}:${J}"]`);if(!qe)return;const Me=qe.getBoundingClientRect(),Ie=Math.min(1,Math.max(0,(we.clientX-Me.left)/Me.width));L()[N].tracks[J].keyframes[ae].t=Ie;const He=qe.querySelector(`[data-kf="${N}:${J}:${ae}"]`);He&&(He.style.left=(Ie*100).toFixed(2)+"%"),R()},be=()=>{window.removeEventListener("pointermove",Ae),window.removeEventListener("pointerup",be),k(U)};window.addEventListener("pointermove",Ae),window.addEventListener("pointerup",be),k(U)})),U.querySelectorAll("[data-add-tracks]").forEach(b=>b.addEventListener("click",()=>{const v=Number(b.getAttribute("data-add-tracks")),J=U.querySelector(`[data-builder-joint="${v}"]`).value.trim()||ye[0]||"joint.root",oe=L()[v].tracks;for(const ae of["x","y","z"]){const Ae=U.querySelector(`[data-builder-axis="${v}:${ae}"]`);Ae!=null&&Ae.checked&&!oe.some(be=>be.joint===J&&be.axis===ae)&&oe.push({joint:J,axis:ae,keyframes:[{t:0,value:0},{t:1,value:0}]})}R(),k(U)})),U.querySelectorAll("[data-kf-val]").forEach(b=>b.addEventListener("input",()=>{const[v,N,J]=b.getAttribute("data-kf-val").split(":").map(Number);L()[v].tracks[N].keyframes[J].value=(parseFloat(b.value)||0)*(Math.PI/180),R()})),U.querySelectorAll("[data-kf-del]").forEach(b=>b.addEventListener("click",()=>{const[v,N,J]=b.getAttribute("data-kf-del").split(":").map(Number),oe=L()[v].tracks[N].keyframes;oe.length>1&&oe.splice(J,1),y&&y.clip===v&&y.track===N&&y.kf===J&&(y=null),R(),k(U)})),U.querySelectorAll("[data-del-track]").forEach(b=>b.addEventListener("click",()=>{const[v,N]=b.getAttribute("data-del-track").split(":").map(Number);L()[v].tracks.splice(N,1),y&&y.clip===v&&y.track===N&&(y=null),R(),k(U)})),U.querySelectorAll("[data-del-clip]").forEach(b=>b.addEventListener("click",()=>{const v=Number(b.getAttribute("data-del-clip"));L().splice(v,1),y&&y.clip===v&&(y=null),R(),k(U)})),U.querySelectorAll("[data-toggle-clip]").forEach(b=>b.addEventListener("click",()=>{const v=Number(b.getAttribute("data-toggle-clip"));M.has(v)?M.delete(v):M.add(v),k(U)})),U.querySelector("[data-add-clip]").addEventListener("click",()=>{const b=L(),v=b.filter(N=>N.name.startsWith("custom")).length+1;b.push({name:`custom${v}`,label:`Custom ${v}`,duration:1,tracks:[]}),R(),k(U)})}function V(){const U=h.querySelector(".inspector-body"),te=m?Nn(s.root,m):null;if(U.innerHTML="",!te){U.innerHTML='<p class="muted">在视图或骨架中选中一个节点以编辑其变换与材质。</p>';return}U.appendChild(ce(te))}function q(U,te,ye){const de=document.createElement("label");de.className="field",de.innerHTML=`<span>${U}</span>`;const E=document.createElement("input");return E.type="number",E.step="0.1",E.value=String(te),E.addEventListener("input",()=>ye(parseFloat(E.value)||0)),de.appendChild(E),de}function G(U,te,ye){const de=document.createElement("div");de.className="vec3";const E=["X","Y","Z"];return["x","y","z"].forEach((B,re)=>{de.appendChild(q(`${U} ${E[re]}`,te[B],pe=>ye({...te,[B]:pe})))}),de}function ce(U){if(U.shape==="instance")return K(U);const te=document.createElement("div");te.className="inspector-form";const ye=document.createElement("label");ye.className="field full",ye.innerHTML="<span>名称</span>";const de=document.createElement("input");de.value=U.name,de.addEventListener("input",()=>{U.name=de.value,z()}),ye.appendChild(de),te.appendChild(ye);const E=(re,pe,ge)=>{const De=document.createElement("div");return De.className="group",De.innerHTML=`<div class="group-title">${re}</div>`,De.appendChild(G(re,pe,ge)),De};te.appendChild(E("位置 Position",U.position,re=>{U.position=re,xe()})),te.appendChild(E("旋转 Rotation (rad)",U.rotation,re=>{U.rotation=re,xe()})),te.appendChild(E("缩放 Scale",U.scale,re=>{U.scale=re,xe()}));const B=document.createElement("button");return B.className="btn small danger full",B.textContent="删除此部件",B.addEventListener("click",()=>{Nr(s.root,U.id),m=null,ve()}),te.appendChild(B),te}function K(U){const te=document.createElement("div");te.className="inspector-form",te.innerHTML=`
      <div class="group">
        <div class="group-title">实例引用 Instance</div>
        <p class="muted">该部件整体引用了另一个元件，内部细节不可在此编辑。</p>
        <label class="field full"><span>名称</span></label>
  ...
  `,t.insertBefore(p,n);let d=no(),u=e,g=!1,x=[];window.addEventListener("beforeunload",S=>{g&&(S.preventDefault(),S.returnValue="")});function f(S){g=!0,m(S+"（未保存）")}function m(S){p.querySelector(".save-state").textContent=S}async function w(){const S=await la();s.innerHTML="<h4>场景 Scenes</h4>";const O=document.createElement("button");O.className="btn small full",O.textContent="+ 新建场景",O.addEventListener("click",()=>{u=void 0,d=no(),p.querySelector(".name-input").value=d.name,g=!1,m(""),h.setScene(d,x),C(null)}),s.appendChild(O);const k=document.createElement("div");k.className="scene-items";for(const V of S){const q=document.createElement("div");q.className="scene-item"+(V.id===u?" active":""),q.innerHTML=`<span class="sname">${V.name}</span><button class="sdel" title="删除">×</button>`,q.addEventListener("click",async G=>{if(G.target.classList.contains("sdel")){confirm(`删除场景「${V.name}」？`)&&(await xd(V.id),u===V.id&&(u=void 0),w());return}await M(V.id)}),k.appendChild(q)}s.appendChild(k)}async function M(S){const O=await Yr(S);O&&(u=S,d=O,p.querySelector(".name-input").value=d.name,g=!1,m(""),await h.setScene(d,x),C(null),w())}function y(){c.innerHTML=`
    ...
    `,c.querySelectorAll("[data-tool]").forEach(ce=>ce.addEventListener("click",()=>{const K=ce.getAttribute("data-tool");h.setTerrainTool(K),c.querySelectorAll("[data-tool]").forEach(me=>me.classList.remove("active")),ce.classList.add("active")}));const S=c.querySelector("[data-brush-size]"),O=c.querySelector("[data-brush-size-v]");S.addEventListener("input",()=>{O.textContent=S.value,L()});const k=c.querySelector("[data-brush-strength]"),V=c.querySelector("[data-brush-strength-v]");k.addEventListener("input",()=>{V.textContent=k.value,L()});const q=c.querySelector("[data-water]"),G=c.querySelector("[data-water-v]");q.addEventListener("input",()=>{G.textContent=parseFloat(q.value).toFixed(1),h.setWaterLevel(parseFloat(q.value)),f("水位已调整")}),c.querySelector("[data-reset]").addEventListener("click",()=>{d.terrain.heights=d.terrain.heights.map(()=>0),d.terrain.water=d.terrain.water.map(()=>0),h.setScene(d,x),f("地形已重置")}),L()}function L(){const S=parseFloat(c.querySelector("[data-brush-size]").value),O=parseFloat(c.querySelector("[data-brush-strength]").value);h.setBrush(S,O)}async function R(){c.innerHTML=`
  ...
  `,t.insertBefore(h,n);let p=null,d=[],u=null,g=e,x=null,f=null,m=null;function w(ie){h.querySelector(".save-state").textContent=ie}function M(ie){w(ie+"（未保存）")}async function y(){const ie=await la();s.innerHTML='<h4>场景 Scenes</h4><div class="scene-items"></div>';const le=s.querySelector(".scene-items");for(const A of ie){const I=document.createElement("div");I.className="scene-item"+(p&&p.id===A.id?" active":""),I.innerHTML=`<span class="sname">${A.name}</span>`,I.addEventListener("click",()=>L(A.id)),le.appendChild(I)}}async function L(ie){const le=await Yr(ie);le&&(p=le,d=await On(),await l.setScene(p,d),h.querySelector(".name-input").value=p.name+" 动画",g=void 0,u=null,x=null,await R(ie))}async function R(ie){const le=await Tc(ie);let A=s.querySelector(".anim-items-box");A||(A=document.createElement("div"),A.className="anim-items-box",s.appendChild(A)),A.innerHTML="<h4>动画 Animations</h4>";const I=document.createElement("button");I.className="btn small full",I.textContent="＋ 从场景创建动画",I.addEventListener("click",()=>C(ie)),A.appendChild(I);const X=document.createElement("div");X.className="anim-items";for(const Y of le){const fe=document.createElement("div");fe.className="anim-item"+(g===Y.id?" active":""),fe.innerHTML=`<span class="aname">${Y.name}</span><button class="sdel" title="删除">×</button>`,fe.addEventListener("click",U=>{if(U.target.classList.contains("sdel")){confirm(`删除动画「${Y.name}」？`)&&Sd(Y.id).then(()=>{g===Y.id&&(u=null,g=void 0),R(ie)});return}z(Y.id)}),X.appendChild(fe)}A.appendChild(X)}async function C(ie){const le=p;u=Kr(ie,le.name,le.size),g=void 0,x=null,h.querySelector(".name-input").value=u.name,l.setAnimation(u),ne(),_(),await R(ie),M("已新建（未保存）")}async function z(ie){const le=await yd(ie);if(le){if(!p||p.id!==le.sceneId){const A=await Yr(le.sceneId);A&&(p=A,d=await On(),await l.setScene(p,d))}u=le,g=ie,x=null,h.querySelector(".name-input").value=u.name,l.setAnimation(u),ne(),_(),await R(le.sceneId),w("")}}function ne(){o.innerHTML=`
    ...
    `,O(),k(),G(),xe()}function S(){const ie=new Set;return u==null||u.tracks.forEach(le=>{le.kind==="object"&&le.objectId&&ie.add(le.objectId)}),ie}function O(){const ie=a.querySelector(".track-list");if(!u){ie.innerHTML='<p class="muted">先选择一个场景并创建 / 加载动画。</p>';return}ie.innerHTML="";for(const le of u.tracks){const A=document.createElement("div");A.className="track-row"+(le.id===x?" selected":"");const I=le.kind==="camera"?"🎥":le.kind==="cameraTarget"?"🎯":"📦",X=le.kind==="camera"?"相机 Camera":le.kind==="cameraTarget"?"相机目标 Target":le.label??"物件",Y=le.kind==="object"?`<button class="row-del" data-del-track="${le.id}" title="删除轨道">×</button>`:"";A.innerHTML=`<span class="ticon">${I}</span><span class="tname">${X}</span>${Y}`,A.addEventListener("click",fe=>{fe.target.classList.contains("row-del")||(x=le.id,l.selectTrack(le.id),O(),G())}),ie.appendChild(A)}}function k(){const ie=a.querySelector(".add-track");if(!p){ie.innerHTML="";return}const le=S(),A=p.objects.filter(I=>!le.has(I.id));if(A.length===0){ie.innerHTML='<p class="muted tiny">场景中所有物件已绑定轨道（每个物件最多一个）。</p>';return}ie.innerHTML=`
    ...
    `,ie.querySelector("[data-add-track]").addEventListener("click",()=>{const X=ie.querySelector("[data-obj]").value;!X||!u||q(X)})}function V(ie){return p==null?void 0:p.objects.find(le=>le.id===ie)}function q(ie){const le=V(ie);if(!le||!u)return;const A={id:Bv(),kind:"object",objectId:ie,label:le.name,keyframes:[{time:0,position:{...le.position},rotation:{...le.rotation},scale:{...le.scale}}]};u.tracks.push(A),x=A.id,l.refresh(),l.selectTrack(A.id),O(),k(),G(),xe(),M("已添加轨道")}function G(){const ie=a.querySelector(".inspector-body");if(ie.innerHTML="",!u||!x){ie.innerHTML='<p class="muted">在上方选择一个轨道进行编辑；相机 / 目标轨道可用「记录关键帧」在时间轴上取景。</p>';return}const le=u.tracks.find(de=>de.id===x);if(!le)return;if(le.kind==="camera"||le.kind==="cameraTarget"){ie.innerHTML=`<div class="group"><div class="group-title">${le.kind==="camera"?"相机":"相机目标"} 轨道</div>
        <p class="muted">移动视角后用工具栏「记录相机/目标关键帧」在当前时间写入关键帧（空 node）。关键帧之间线性插值。</p></div>`;return}const A=le.objectId?V(le.objectId):void 0;if(!A){ie.innerHTML='<p class="muted">绑定的物件不存在。</p>';return}const I=document.createElement("div");I.className="group-title",I.textContent=`物件轨道：${le.label??A.name}`,ie.appendChild(I);const X=document.createElement("div");X.className="toolbar-row",X.innerHTML=`
      <span class="muted">变换：</span>
      <button class="btn tiny mode active" data-xmode="translate">移动</button>
      <button class="btn tiny mode" data-xmode="rotate">旋转</button>
      <button class="btn tiny mode" data-xmode="scale">缩放</button>`,X.querySelectorAll("[data-xmode]").forEach(de=>de.addEventListener("click",()=>{l.setTransformMode(de.getAttribute("data-xmode")),X.querySelectorAll(".mode").forEach(E=>E.classList.remove("active")),de.classList.add("active")})),ie.appendChild(X);const Y=K(le),fe=(de,E,B)=>{const re=document.createElement("div");re.className="group",re.innerHTML=`<div class="group-title">${de}</div>`;const pe=document.createElement("div");pe.className="vec3",["x","y","z"].forEach((ge,De)=>{const he=document.createElement("label");he.className="field",he.innerHTML=`<span>${["X","Y","Z"][De]}</span>`;const b=document.createElement("input");b.type="number",b.step="0.1",b.value=String(E[ge]),b.addEventListener("input",()=>{B({...E,[ge]:parseFloat(b.value)||0})}),he.appendChild(b),pe.appendChild(he)}),re.appendChild(pe),ie.appendChild(re)};fe("位置 Position",Y.position,de=>{me(le,l.getTime(),de,Y.rotation,Y.scale),ce(A,le)}),fe("旋转 Rotation (rad)",Y.rotation,de=>{me(le,l.getTime(),Y.position,de,Y.scale),ce(A,le)}),fe("缩放 Scale",Y.scale,de=>{me(le,l.getTime(),Y.position,Y.rotation,de),ce(A,le)});const U=document.createElement("div");U.className="group",U.innerHTML='<div class="group-title">区段动画状态 Segment State</div>';const te=document.createElement("select");te.className="state-select",te.innerHTML=dh.map(de=>`<option value="${de.value}" ${Y.state===de.value?"selected":""}>${de.label}</option>`).join(""),te.addEventListener("change",()=>{const de=K(le,!0);de.state=te.value,l.refresh(),M("状态已设置"),xe()}),U.appendChild(te),ie.appendChild(U);const ye=document.createElement("div");ye.className="group",ye.innerHTML='<div class="group-title">关键帧 Keyframes</div>',le.keyframes.forEach((de,E)=>{const B=document.createElement("div");B.className="kf-row",B.innerHTML='<span class="kf-time">t</span>';const re=document.createElement("input");re.type="number",re.step="0.1",re.min="0",re.value=de.time.toFixed(2),re.addEventListener("input",()=>{de.time=Math.max(0,Math.min(u.duration,parseFloat(re.value)||0)),le.keyframes.sort((De,he)=>De.time-he.time),l.refresh(),xe()});const pe=document.createElement("select");pe.innerHTML=dh.map(De=>`<option value="${De.value}" ${de.state===De.value?"selected":""}>${De.label}</option>`).join(""),pe.addEventListener("change",()=>{de.state=pe.value,l.refresh(),xe()});const ge=document.createElement("button");ge.className="row-del",ge.textContent="×",ge.addEventListener("click",()=>{le.keyframes.splice(E,1),l.refresh(),G(),xe(),M("已删除关键帧")}),B.append(re,pe,ge),ye.appendChild(B)}),ie.appendChild(ye)}function ce(ie,le){const A=K(le);ie.position={...A.position},ie.rotation={...A.rotation},ie.scale={...A.scale},l.setSelectedObjectTransform(ie),M("已调整关键帧")}function K(ie,le=!1){const A=l.getTime();let I=ie.keyframes.find(X=>Math.abs(X.time-A)<.001);if(!I&&le){const X=ie.objectId?V(ie.objectId):void 0;I={time:A,position:X?{...X.position}:P(),rotation:X?{...X.rotation}:P(),scale:X?{...X.scale}:P(1,1,1)},ie.keyframes.push(I),ie.keyframes.sort((Y,fe)=>Y.time-fe.time)}return I||(I=ie.keyframes[0]??{time:A,position:P(),rotation:P(),scale:P(1,1,1)}),I}function me(ie,le,A,I,X){let Y=ie.keyframes.find(fe=>Math.abs(fe.time-le)<.001);Y||(Y={time:le,position:{...A},rotation:I??P(),scale:X??P(1,1,1)},ie.keyframes.push(Y),ie.keyframes.sort((fe,U)=>fe.time-U.time)),Y.position={...A},I&&(Y.rotation={...I}),X&&(Y.scale={...X}),l.refresh(),M("已调整关键帧")}function xe(){const ie=a.querySelector(".timeline-list");if(!u){ie.innerHTML="";return}const le=u.duration;ie.innerHTML="";for(const A of u.tracks){const I=document.createElement("div");I.className="tl-track"+(A.id===x?" selected":"");const X=A.kind==="camera"?"🎥":A.kind==="cameraTarget"?"🎯":"📦";I.innerHTML=`<span class="tl-label">${X}</span><div class="tl-bar" data-track="${A.id}"></div>`;const Y=I.querySelector(".tl-bar");for(const U of A.keyframes){const te=document.createElement("span");te.className="tl-dot"+(U.state&&U.state!=="none"?" has-state":""),te.style.left=(U.time/le*100).toFixed(2)+"%",te.title=`t=${U.time.toFixed(2)}s${U.state&&U.state!=="none"?" · "+U.state:""}`,te.addEventListener("click",ye=>{ye.stopPropagation(),l.setTime(U.time),A.kind==="object"&&(x=A.id,l.selectTrack(A.id),O())}),Y.appendChild(te)}const fe=document.createElement("span");fe.className="tl-playhead",Y.appendChild(fe),Y.addEventListener("click",U=>{const te=Y.getBoundingClientRect(),ye=Math.max(0,Math.min(le,(U.clientX-te.left)/te.width*le));l.setTime(ye)}),I.addEventListener("click",()=>{A.kind==="object"&&(x=A.id,l.selectTrack(A.id),O(),G())}),ie.appendChild(I)}ve(l.getTime())}function ve(ie){if(!u)return;const le=u.duration;a.querySelectorAll(".tl-bar").forEach(A=>{const I=A.querySelector(".tl-playhead");I&&(I.style.left=(ie/le*100).toFixed(2)+"%")})}h.querySelector("[data-save]").addEventListener("click",async()=>{if(!u||!p){w("请先选择场景");return}const ie=h.querySelector(".name-input").value||"Untitled Animation";u.name=ie,u.thumbnail=l.captureThumbnail();const le={name:u.name,sceneId:p.id,duration:u.duration,tracks:u.tracks,thumbnail:u.thumbnail};try{g?await Md(g,le):g=(await Ac(le)).id,w("已保存 ✓")}catch(A){w("保存失败："+A.message)}}),await y(),e?await z(e):(ne(),_())}const Td="火车大劫案 Train Robbery",bt=40,Ln=15,Gv=96,Vv=64,ft=Math.PI/2;let fh=0;function Wv(i){return fh+=1,`${i}_${Date.now().toString(36)}_${fh.toString(36)}`}function $(i,e,t){return{x:i,y:e,z:t}}function Pn(i,e,t){return{id:Wv("track"),kind:"object",objectId:i,label:e,keyframes:t.map(n=>({time:n.t,position:{...n.pos},rotation:n.rot??$(0,0,0),scale:$(1,1,1),...n.state?{state:n.state}:{}}))}}function Es(i,e,t){return i+(e-i)*t}function br(i,e){return Math.atan2(e.x-i.x,e.z-i.z)}function en(i,e){let t=0;return t+=Math.max(0,Math.abs(i)-34)*.28,t+=Math.max(0,Math.abs(e)-30)*.22,t>0&&(t+=Math.sin(i*.22)*Math.cos(e*.18)*.6),t}async function jv(){const e=(await la()).find(t=>t.name===Td);if(e){const t=await Tc(e.id);if(t.length)return{sceneId:e.id,animationId:t[0].id}}return Xv()}async function Xv(){const i=await dn(nu()),e=await dn(iu()),t=await dn(su()),n=await dn(ru()),s=await dn(au()),r=await dn(ou()),a=await dn(cu()),o=ui(i.root),c=ui(e.root),l=ui(n.root),h=ui(s.root),p=ui(a.root),u=2.51+p,g=E=>Es(-12,40,E/bt),x=(E,B)=>g(B)-7*E,f=(E,B)=>h+en(E,B),m=E=>o+en(g(E),0),w=(E,B)=>c+en(x(E,B),0),M=(E,B)=>u+en(x(E,B),0),y=(E,B,re,pe)=>{if(pe<=Ln){const De=pe/Ln;return{x:Es(E.x,B.x,De),z:Es(E.z,B.z,De)}}const ge=(pe-Ln)/(bt-Ln);return{x:Es(B.x,re.x,ge),z:Es(B.z,re.z,ge)}},L=[{s:{x:-42,z:24},m:{x:-3,z:4},e:{x:40,z:8}},{s:{x:-44,z:27},m:{x:2,z:3},e:{x:40,z:6}},{s:{x:-40,z:29},m:{x:5,z:6},e:{x:26,z:16}},{s:{x:-45,z:22},m:{x:-5,z:5},e:{x:36,z:9}},{s:{x:-43,z:26},m:{x:7,z:3},e:{x:40,z:7}},{s:{x:-41,z:30},m:{x:1,z:7},e:{x:32,z:17}},{s:{x:-39,z:23},m:{x:-6,z:4},e:{x:42,z:6}}],R=1,C=4,z={2:26,5:37},ne=[{s:{x:-43,z:20},m:{x:-1,z:3},e:{x:44,z:6}},{s:{x:-45,z:23},m:{x:3,z:2},e:{x:44,z:5}}],_=[],S=si(t.id,"铁轨 Rail");S.position=$(0,ui(t.root),0),_.push(S);const O=si(i.id,"火车头 Locomotive");O.position=$(g(0),m(0),0),_.push(O);const k=[];for(let E=1;E<=3;E++){const B=si(e.id,`车厢 Car ${E}`);B.position=$(x(E,0),w(E,0),0),k.push(B),_.push(B)}const V=[];for(let E=1;E<=3;E++){const B=si(a.id,`护卫 Defender ${E}`);B.position=$(x(E,0),M(E,0),0),V.push(B),_.push(B)}const q=[];for(let E=0;E<L.length;E++){const B=L[E],re=si(s.id,`劫匪 Bandit ${E+1}`);re.position=$(B.s.x,f(B.s.x,B.s.z),B.s.z),re.rotation=$(0,br(B.s,B.m),0),q.push(re),_.push(re)}const G=[];for(let E=0;E<ne.length;E++){const B=ne[E],re=si(r.id,`护卫骑兵 Defender Rider ${E+1}`);re.position=$(B.s.x,f(B.s.x,B.s.z),B.s.z),re.rotation=$(0,br(B.s,B.m),0),G.push(re),_.push(re)}const ce=[[-22,20,.9],[14,22,1.1],[-8,24,.8],[20,19,1],[-30,23,1.2],[4,26,.85],[-16,22,1],[26,21,1.05],[-2,-22,.95],[10,-21,1.1],[-26,-22,1],[30,-20,.9],[-40,18,1.15],[38,16,1.2],[-38,-16,1],[40,-18,1.1],[-14,-26,.9],[22,-25,1.05],[-34,30,1.3],[34,28,1.25],[0,30,.9],[-44,-4,1.1],[44,2,1.1],[-6,28,.8]];for(let E=0;E<ce.length;E++){const[B,re,pe]=ce[E],ge=si(n.id,`树 Tree ${E+1}`);ge.position=$(B,l+en(B,re),re),ge.rotation=$(0,E*1.3%(Math.PI*2),0),ge.scale=$(pe,pe,pe),_.push(ge)}const K=Mh(Gv,Vv,"#c2a878"),me=K.segments+1;for(let E=0;E<me;E++)for(let B=0;B<me;B++){const re=-K.size/2+B/K.segments*K.size,pe=-K.size/2+E/K.segments*K.size;K.heights[E*me+B]=en(re,pe)}const xe=await bc({name:Td,size:K.size,waterLevel:-4,terrain:K,objects:_}),ve=Kr(xe.id,xe.name,xe.size,"火车大劫案 · 动画");ve.duration=bt;const ie=(E,B)=>y(L[E].s,L[E].m,L[E].e,B),le=ve.tracks.find(E=>E.kind==="camera"),A=ve.tracks.find(E=>E.kind==="cameraTarget"),I=ie(0,0),X=ie(0,8),Y=L[R].m,fe=y(L[2].s,L[2].m,L[2].e,26),U=y(L[C].s,L[C].m,L[C].e,31),te=en(U.x,U.z);le.keyframes=[{time:0,position:$(I.x-14,14,I.z-18),rotation:$(0,0,0),scale:$(1,1,1)},{time:8,position:$(X.x-12,8,X.z-14),rotation:$(0,0,0),scale:$(1,1,1)},{time:15,position:$(-2,20,34),rotation:$(0,0,0),scale:$(1,1,1)},{time:17,position:$(Y.x+3,3,Y.z+6),rotation:$(0,0,0),scale:$(1,1,1)},{time:20,position:$(Y.x+3,3,Y.z+6),rotation:$(0,0,0),scale:$(1,1,1)},{time:21,position:$(x(1,21)-1,3.5,7),rotation:$(0,0,0),scale:$(1,1,1)},{time:25,position:$(x(1,21)-1,3.5,7),rotation:$(0,0,0),scale:$(1,1,1)},{time:26,position:$(fe.x-3,3,fe.z+8),rotation:$(0,0,0),scale:$(1,1,1)},{time:30,position:$(fe.x-3,3,fe.z+8),rotation:$(0,0,0),scale:$(1,1,1)},{time:31,position:$(U.x+2.5,te+3,U.z+5),rotation:$(0,0,0),scale:$(1,1,1)},{time:36,position:$(U.x+2.5,te+3,U.z+5),rotation:$(0,0,0),scale:$(1,1,1)},{time:bt,position:$(52,20,30),rotation:$(0,0,0),scale:$(1,1,1)}],A.keyframes=[{time:0,position:$(I.x,en(I.x,I.z)+2,I.z),rotation:$(0,0,0),scale:$(1,1,1)},{time:8,position:$(X.x,en(X.x,X.z)+2,X.z),rotation:$(0,0,0),scale:$(1,1,1)},{time:15,position:$(0,2,0),rotation:$(0,0,0),scale:$(1,1,1)},{time:17,position:$(Y.x,2.2,Y.z),rotation:$(0,0,0),scale:$(1,1,1)},{time:20,position:$(Y.x,2.2,Y.z),rotation:$(0,0,0),scale:$(1,1,1)},{time:21,position:$(x(1,21),2,2),rotation:$(0,0,0),scale:$(1,1,1)},{time:25,position:$(x(1,21),1.5,3),rotation:$(0,0,0),scale:$(1,1,1)},{time:26,position:$(fe.x,2,fe.z),rotation:$(0,0,0),scale:$(1,1,1)},{time:30,position:$(fe.x,1.5,fe.z),rotation:$(0,0,0),scale:$(1,1,1)},{time:31,position:$(U.x,te+2.8,U.z),rotation:$(0,0,0),scale:$(1,1,1)},{time:36,position:$(U.x,te+1.4,U.z+1),rotation:$(0,0,0),scale:$(1,1,1)},{time:bt,position:$(42,2,0),rotation:$(0,0,0),scale:$(1,1,1)}],ve.tracks.push(Pn(O.id,"火车头",[{t:0,pos:$(g(0),m(0),0)},{t:bt,pos:$(g(bt),m(bt),0)}]));for(let E=1;E<=3;E++)ve.tracks.push(Pn(k[E-1].id,`车厢 ${E}`,[{t:0,pos:$(x(E,0),w(E,0),0)},{t:bt,pos:$(x(E,bt),w(E,bt),0)}]));const ye=[{idx:0,Te:21,Fd:4},{idx:1,Te:27,Fd:2.5}];for(let E=1;E<=3;E++){const B=V[E-1],re=ye.find(pe=>pe.idx===E-1);if(re){const pe=x(E,re.Te),ge=en(pe,3)+p;ve.tracks.push(Pn(B.id,`护卫 ${E}（中枪坠车）`,[{t:0,pos:$(x(E,0),M(E,0),0),state:"idle"},{t:re.Te-.5,pos:$(x(E,re.Te-.5),M(E,re.Te-.5),0),state:"idle"},{t:re.Te,pos:$(pe,M(E,re.Te)-.2,.6),rot:$(0,0,.4),state:"idle"},{t:re.Te+.5,pos:$(pe,M(E,re.Te)-.8,1.5),rot:$(0,0,.9),state:"idle"},{t:re.Te+1.5,pos:$(pe,ge+.6,2.5),rot:$(0,0,1.3),state:"idle"},{t:re.Te+re.Fd,pos:$(pe-.5,ge,3),rot:$(0,0,Math.PI/2),state:"idle"},{t:bt,pos:$(pe-1.5,ge,3),rot:$(0,0,Math.PI/2),state:"idle"}]))}else ve.tracks.push(Pn(B.id,`护卫 ${E}`,[{t:0,pos:$(x(E,0),M(E,0),0),state:"idle"},{t:bt,pos:$(x(E,bt),M(E,bt),0),state:"idle"}]))}for(let E=0;E<L.length;E++){const B=L[E],re=q[E],pe=br(B.s,B.m);if(E===R)ve.tracks.push(Pn(re.id,`劫匪 ${E+1}（假装攻击·慢放）`,[{t:0,pos:$(B.s.x,f(B.s.x,B.s.z),B.s.z),rot:$(0,pe,0),state:"walk"},{t:Ln,pos:$(B.m.x,f(B.m.x,B.m.z),B.m.z),rot:$(0,ft,0),state:"walk"},{t:17,pos:$(B.m.x+.5,f(B.m.x+.5,B.m.z),B.m.z),rot:$(.22,ft,0),state:"walk"},{t:19,pos:$(B.m.x+1.5,f(B.m.x+1.5,B.m.z),B.m.z),rot:$(.35,ft,0),state:"walk"},{t:20,pos:$(B.m.x+2.5,f(B.m.x+2.5,B.m.z),B.m.z),rot:$(0,ft,0),state:"walk"},{t:bt,pos:$(B.e.x,f(B.e.x,B.e.z),B.e.z),rot:$(0,ft,0),state:"walk"}]));else if(z[E]!==void 0){const ge=z[E],De=E===2?4:2,he=y(B.s,B.m,B.e,ge),b=(v,N)=>en(v,N);ve.tracks.push(Pn(re.id,`劫匪 ${E+1}（中枪翻倒·慢放）`,[{t:0,pos:$(B.s.x,f(B.s.x,B.s.z),B.s.z),rot:$(0,pe,0),state:"walk"},{t:Ln,pos:$(B.m.x,f(B.m.x,B.m.z),B.m.z),rot:$(0,ft,0),state:"walk"},{t:ge-.6,pos:$(he.x,f(he.x,he.z),he.z),rot:$(0,ft,0),state:"walk"},{t:ge,pos:$(he.x,f(he.x,he.z+.5),he.z+.5),rot:$(0,ft,-.3),state:"none"},{t:ge+1,pos:$(he.x+1.5,b(he.x+1.5,he.z+2)+h*.8,he.z+2),rot:$(0,ft,-.9),state:"none"},{t:ge+2.5,pos:$(he.x+3,b(he.x+3,he.z+3.5)+h*.5,he.z+3.5),rot:$(0,ft,-1.6),state:"none"},{t:ge+De,pos:$(he.x+3,b(he.x+3,he.z+4)+h*.45,he.z+4),rot:$(0,ft,Math.PI),state:"none"},{t:bt,pos:$(he.x+3,b(he.x+3,he.z+4)+h*.45,he.z+4),rot:$(0,ft,Math.PI),state:"none"}]))}else if(E===C){const he=y(B.s,B.m,B.e,31),b=(v,N)=>en(v,N);ve.tracks.push(Pn(re.id,`劫匪 ${E+1}（骑手中枪坠马·慢放）`,[{t:0,pos:$(B.s.x,f(B.s.x,B.s.z),B.s.z),rot:$(0,pe,0),state:"walk"},{t:Ln,pos:$(B.m.x,f(B.m.x,B.m.z),B.m.z),rot:$(0,ft,0),state:"walk"},{t:31-.6,pos:$(he.x,f(he.x,he.z),he.z),rot:$(0,ft,0),state:"walk"},{t:31,pos:$(he.x,f(he.x,he.z),he.z),rot:$(-.45,ft,0),state:"idle"},{t:31+.6,pos:$(he.x,f(he.x,he.z),he.z),rot:$(-.3,ft,.15),state:"idle"},{t:31+1.6,pos:$(he.x+.4,f(he.x,he.z+.6)-.2,he.z+.6),rot:$(.5,ft,.5),state:"none"},{t:34,pos:$(he.x+.8,b(he.x,he.z+1.6)+h*.7,he.z+1.6),rot:$(.3,ft,1.1),state:"none"},{t:36,pos:$(he.x+1,b(he.x,he.z+2.6)+h*.5,he.z+2.6),rot:$(0,ft,Math.PI/2),state:"none"},{t:bt,pos:$(he.x+1,b(he.x,he.z+2.6)+h*.5,he.z+2.6),rot:$(0,ft,Math.PI/2),state:"none"}]))}else ve.tracks.push(Pn(re.id,`劫匪 ${E+1}`,[{t:0,pos:$(B.s.x,f(B.s.x,B.s.z),B.s.z),rot:$(0,pe,0),state:"walk"},{t:Ln,pos:$(B.m.x,f(B.m.x,B.m.z),B.m.z),rot:$(0,ft,0),state:"walk"},{t:bt,pos:$(B.e.x,f(B.e.x,B.e.z),B.e.z),rot:$(0,ft,0),state:"walk"}]))}for(let E=0;E<ne.length;E++){const B=ne[E],re=G[E],pe=br(B.s,B.m);ve.tracks.push(Pn(re.id,`护卫骑兵 ${E+1}`,[{t:0,pos:$(B.s.x,f(B.s.x,B.s.z),B.s.z),rot:$(0,pe,0),state:"walk"},{t:Ln,pos:$(B.m.x,f(B.m.x,B.m.z),B.m.z),rot:$(0,ft,0),state:"walk"},{t:bt,pos:$(B.e.x,f(B.e.x,B.e.z),B.e.z),rot:$(0,ft,0),state:"walk"}]))}const de=await Ac({name:ve.name,sceneId:xe.id,duration:ve.duration,tracks:ve.tracks});return{sceneId:xe.id,animationId:de.id}}async function qv(i){const e=document.createElement("div");e.className="page",e.appendChild(Fn("home"));const t=document.createElement("section");t.className="hero",t.innerHTML=`
    <h1>火车大劫案</h1>
  ...
  `,s.appendChild(o);const c=document.createElement("div");c.className="roam-rec",c.innerHTML='<span class="dot"></span><span class="rec-time">REC 00:00</span>',c.hidden=!0,s.appendChild(c),i.appendChild(t);let l=[],h=e,p=0,d=0;const u=new Qv(r,{onRecordingChange:y=>{s.classList.toggle("roam-recording",y),c.hidden=!y;const L=o.querySelector("[data-record]");y?(L.textContent="■ 停止 Stop",L.classList.add("active"),p=Date.now(),d=window.setInterval(g,500),g()):(L.textContent="● 录制 Record",L.classList.remove("active"),window.clearInterval(d))}});function g(){const y=Math.floor((Date.now()-p)/1e3),L=String(Math.floor(y/60)).padStart(2,"0"),R=String(y%60).padStart(2,"0");c.querySelector(".rec-time").textContent=`REC ${L}:${R}`}const x=y=>{n.querySelector(".roam-state").textContent=y};async function f(y){const L=await Yr(y);if(!L){x("场景不存在");return}await u.setScene(L,l),h=y,x(`已载入：${L.name}`)}async function m(){const y=await la(),L=n.querySelector("[data-scene]");L.innerHTML='<option value="">— 请选择场景 —</option>'+y.map(R=>`<option value="${R.id}">${R.name}</option>`).join(""),h&&(L.value=h),L.addEventListener("change",()=>{L.value&&f(L.value)})}o.querySelectorAll("[data-mode]").forEach(y=>y.addEventListener("click",()=>{const L=y.getAttribute("data-mode");u.setMode(L),o.querySelectorAll("[data-mode]").forEach(R=>R.classList.remove("active")),y.classList.add("active")}));const w=o.querySelector("[data-speed]"),M=o.querySelector("[data-speed-v]");w.addEventListener("input",()=>{M.textContent=w.value,u.setSpeed(parseFloat(w.value))}),o.querySelector("[data-record]").addEventListener("click",async()=>{u.isRecording()?u.stopRecording():await u.startRecording()}),a.querySelector("[data-help-close]").addEventListener("click",()=>{a.hidden=!0}),l=await On(),await m(),h?await f(h):x("请选择一个场景开始漫游")}const tx="modulepreload",nx=function(i,e){return new URL(i,e).href},gh={},ix=function(e,t,n){let s=Promise.resolve();if(t&&t.length>0){const a=document.getElementsByTagName("link"),o=document.querySelector("meta[property=csp-nonce]"),c=(o==null?void 0:o.nonce)||(o==null?void 0:o.getAttribute("nonce"));s=Promise.allSettled(t.map(l=>{if(l=nx(l,n),l in gh)return;gh[l]=!0;const h=l.endsWith(".css"),p=h?'[rel="stylesheet"]':"";if(!!n)for(let g=a.length-1;g>=0;g--){const x=a[g];if(x.href===l&&(!h||x.rel==="stylesheet"))return}else if(document.querySelector(`link[href="${l}"]${p}`))return;const u=document.createElement("link");if(u.rel=h?"stylesheet":tx,h||(u.as="script"),u.crossOrigin="",u.href=l,c&&u.setAttribute("nonce",c),document.head.appendChild(u),h)return new Promise((g,x)=>{u.addEventListener("load",g),u.addEventListener("error",()=>x(new Error(`Unable to preload CSS for ${l}`)))})}))}function r(a){const o=new Event("vite:preloadError",{cancelable:!0});if(o.payload=a,window.dispatchEvent(o),!o.defaultPrevented)throw a}return s.then(a=>{for(const o of a||[])o.status==="rejected"&&r(o.reason);return e().catch(r)})};function sx(i={}){const{immediate:e=!1,onNeedRefresh:t,onOfflineReady:n,onRegistered:s,onRegisteredSW:r,onRegisterError:a}=i;let o,c,l;const h=async(d=!0)=>{await c,await(l==null?void 0:l())};async function p(){if("serviceWorker"in navigator){if(o=await ix(async()=>{const{Workbox:d}=await import("./workbox-window.prod.es5-BqEJf4Xk.js");return{Workbox:d}},[],import.meta.url).then(({Workbox:d})=>new d("./sw.js",{scope:"./",type:"classic"})).catch(d=>{a==null||a(d)}),!o)return;l=async()=>{await(o==null?void 0:o.messageSkipWaiting())};{let d=!1;const u=()=>{d=!0,o==null||o.addEventListener("controlling",g=>{g.isUpdate&&window.location.reload()}),t==null||t()};o.addEventListener("installed",g=>{typeof g.isUpdate>"u"?typeof g.isExternal<"u"?g.isExternal?u():!d&&(n==null||n()):g.isExternal?window.location.reload():!d&&(n==null||n()):g.isUpdate||n==null||n()}),o.addEventListener("waiting",u),o.addEventListener("externalwaiting",u)}o.register({immediate:e}).then(d=>{r?r("./sw.js",d):s==null||s(d)}).catch(d=>{a==null||a(d)})}}return c=p(),h}let to=null;function rx(){const i=document.createElement("style");i.textContent=`
    #pwa-update {
