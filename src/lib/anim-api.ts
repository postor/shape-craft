import type { AnimComponent, AnimInput } from '../schema';
import { isLocalMode } from './settings.ts';

export const LS_KEY = 'shapecraft.animations.v1';
...
/** Notify all animation subscribers (used after an external DB refresh, e.g. ZIP import). */
